...
static void chashdb_init_buff(UINT8 *buff, const UINT32 len)
{
    UINT32 pos;
...
static void chashdb_clean_buff(UINT8 *buff, const UINT32 len)
{
    UINT32 pos;
...
static void chashdb_copy_buff(const UINT8 *src_buff, const UINT32 src_len, UINT8 *des_buff, const UINT32 max_len, UINT32 *len)
{
    UINT32 pos;
...
static void chashdb_print_buff_0(LOG *log, const UINT8 *buff, const UINT32 len)
{
    UINT32 pos;
...
static void chashdb_print_buff(LOG *log, const UINT8 *buff, const UINT32 len)
{
...
CHASHDB_INODE *chashdb_inode_new()
{
    ...
    alloc_static_mem(MD_TASK, CMPI_ANY_MODI, MM_CHASHDB_INODE, &chashdb_inode, LOC_CHASHDB_0001);
...
EC_BOOL chashdb_inode_free(CHASHDB_INODE *chashdb_inode)
{
    if(NULL_PTR != chashdb_inode)
    {
        ...
        free_static_mem(MD_TASK, CMPI_ANY_MODI, MM_CHASHDB_INODE, chashdb_inode, LOC_CHASHDB_0002);
    }
    return (EC_TRUE);
}
#endif
...
CHASHDB_ITEM *chashdb_item_new()
{
    ...
    alloc_static_mem(MD_TASK, CMPI_ANY_MODI, MM_CHASHDB_ITEM, &chashdb_item, LOC_CHASHDB_0003);
...
EC_BOOL chashdb_item_free(CHASHDB_ITEM *chashdb_item)
{
    if(NULL_PTR != chashdb_item)
    {
        ...
        free_static_mem(MD_TASK, CMPI_ANY_MODI, MM_CHASHDB_ITEM, chashdb_item, LOC_CHASHDB_0004);
    }
    return (EC_TRUE);
}
...
CHASHDB_BUCKET *chashdb_bucket_new()
{
    ...
    alloc_static_mem(MD_TASK, CMPI_ANY_MODI, MM_CHASHDB_BUCKET, &chashdb_bucket, LOC_CHASHDB_0005);
...
EC_BOOL chashdb_bucket_free(CHASHDB_BUCKET *chashdb_bucket)
{
    ...
    free_static_mem(MD_TASK, CMPI_ANY_MODI, MM_CHASHDB_BUCKET, chashdb_bucket, LOC_CHASHDB_0006);
    return (EC_TRUE);
}
...
CHASHDB *chashdb_new(const char *dbname)
{
    ...
    alloc_static_mem(MD_TASK, CMPI_ANY_MODI, MM_CHASHDB, &chashdb, LOC_CHASHDB_0009);
...
EC_BOOL chashdb_free(CHASHDB *chashdb)
{
    if(NULL_PTR != chashdb)
    {
        ...
        free_static_mem(MD_TASK, CMPI_ANY_MODI, MM_CHASHDB, chashdb, LOC_CHASHDB_0012);
    }
    return (EC_TRUE);
}
