...
CSYS_CPU_CFG_VEC *csys_cpu_cfg_vec_new()
{
    ...
    alloc_static_mem(MD_TBD, CMPI_ANY_MODI, MM_CVECTOR, &csys_cpu_cfg_vec, LOC_CSYS_0001);
...
UINT32 csys_cpu_cfg_vec_free(CSYS_CPU_CFG_VEC *csys_cpu_cfg_vec)
{
    ...
    free_static_mem(MD_TBD, CMPI_ANY_MODI, MM_CVECTOR, csys_cpu_cfg_vec, LOC_CSYS_0004);
    return (0);
}
...
CSYS_CPU_STAT *csys_cpu_stat_new()
{
    ...
    alloc_static_mem(MD_TBD, CMPI_ANY_MODI, MM_CSYS_CPU_STAT, &csys_cpu_stat, LOC_CSYS_0008);
...
UINT32 csys_cpu_stat_free(CSYS_CPU_STAT *csys_cpu_stat)
{
    ...
    free_static_mem(MD_TBD, CMPI_ANY_MODI, MM_CSYS_CPU_STAT, csys_cpu_stat, LOC_CSYS_0009);
...
CSYS_CPU_STAT_VEC *csys_cpu_stat_vec_new()
{
    ...
    alloc_static_mem(MD_TBD, CMPI_ANY_MODI, MM_CVECTOR, &csys_cpu_stat_vec, LOC_CSYS_0010);
...
UINT32 csys_cpu_stat_vec_free(CSYS_CPU_STAT_VEC *csys_cpu_stat_vec)
{
    ...
    free_static_mem(MD_TBD, CMPI_ANY_MODI, MM_CVECTOR, csys_cpu_stat_vec, LOC_CSYS_0013);
    return (0);
}
...
CSYS_CPU_AVG_STAT *csys_cpu_avg_stat_new()
{
    ...
    alloc_static_mem(MD_TBD, CMPI_ANY_MODI, MM_CSYS_CPU_AVG_STAT, &csys_cpu_avg_stat, LOC_CSYS_0015);
...
UINT32 csys_cpu_avg_stat_free(CSYS_CPU_AVG_STAT *csys_cpu_avg_stat)
{
    ...
    free_static_mem(MD_TBD, CMPI_ANY_MODI, MM_CSYS_CPU_AVG_STAT, csys_cpu_avg_stat, LOC_CSYS_0016);
...
CSYS_MEM_STAT *csys_mem_stat_new()
{
    ...
    alloc_static_mem(MD_TBD, CMPI_ANY_MODI, MM_CSYS_MEM_STAT, &csys_mem_stat, LOC_CSYS_0019);
...
UINT32 csys_mem_stat_free(CSYS_MEM_STAT *csys_mem_stat)
{
    ...
    free_static_mem(MD_TBD, CMPI_ANY_MODI, MM_CSYS_MEM_STAT, csys_mem_stat, LOC_CSYS_0020);
    return (0);
}
...
CPROC_MEM_STAT *cproc_mem_stat_new()
{
    ...
    alloc_static_mem(MD_TBD, CMPI_ANY_MODI, MM_CPROC_MEM_STAT, &cproc_mem_stat, LOC_CSYS_0022);
...
UINT32 cproc_mem_stat_free(CPROC_MEM_STAT *cproc_mem_stat)
{
    ...
    free_static_mem(MD_TBD, CMPI_ANY_MODI, MM_CPROC_MEM_STAT, cproc_mem_stat, LOC_CSYS_0023);
    return (0);
}
...
CPROC_CPU_STAT *cproc_cpu_stat_new()
{
    ...
    alloc_static_mem(MD_TBD, CMPI_ANY_MODI, MM_CPROC_CPU_STAT, &cproc_cpu_stat, LOC_CSYS_0024);
...
UINT32 cproc_cpu_stat_free(CPROC_CPU_STAT *cproc_cpu_stat)
{
    ...
    free_static_mem(MD_TBD, CMPI_ANY_MODI, MM_CPROC_CPU_STAT, cproc_cpu_stat, LOC_CSYS_0025);
    return (0);
}
...
CPROC_THREAD_STAT *cproc_thread_stat_new()
{
    ...
    alloc_static_mem(MD_TBD, CMPI_ANY_MODI, MM_CPROC_THREAD_STAT, &cproc_thread_stat, LOC_CSYS_0033);
...
UINT32 cproc_thread_stat_free(CPROC_THREAD_STAT *cproc_thread_stat)
{
    ...
    free_static_mem(MD_TBD, CMPI_ANY_MODI, MM_CPROC_THREAD_STAT, cproc_thread_stat, LOC_CSYS_0034);
    return (0);
}
...
CPROC_MODULE_STAT *cproc_module_stat_new()
{
    ...
    alloc_static_mem(MD_TBD, CMPI_ANY_MODI, MM_CPROC_MODULE_STAT, &cproc_module_stat, LOC_CSYS_0042);
...
UINT32 cproc_module_stat_free(CPROC_MODULE_STAT *cproc_module_stat)
{
    if(NULL_PTR != cproc_module_stat)
    {
        ...
        free_static_mem(MD_TBD, CMPI_ANY_MODI, MM_CPROC_MODULE_STAT, cproc_module_stat, LOC_CSYS_0043);
    }
    return (0);
}
...
{
    cproc_module_stat_free(cproc_module_stat);
    return (0);
}
...
CPROC_MODULE_STAT_VEC *cproc_module_stat_vec_new()
{
    ...
    alloc_static_mem(MD_TBD, CMPI_ANY_MODI, MM_CVECTOR, &cproc_module_stat_vec, LOC_CSYS_0044);
...
UINT32 cproc_module_stat_vec_free(CPROC_MODULE_STAT_VEC *cproc_module_stat_vec)
{
    ...
    free_static_mem(MD_TBD, CMPI_ANY_MODI, MM_CVECTOR, cproc_module_stat_vec, LOC_CSYS_0047);
    return (0);
}
...
CRANK_THREAD_STAT *crank_thread_stat_new()
{
    ...
    alloc_static_mem(MD_TBD, CMPI_ANY_MODI, MM_CRANK_THREAD_STAT, &crank_thread_stat, LOC_CSYS_0048);
...
UINT32 crank_thread_stat_free(CRANK_THREAD_STAT *crank_thread_stat)
{
    ...
    free_static_mem(MD_TBD, CMPI_ANY_MODI, MM_CRANK_THREAD_STAT, crank_thread_stat, LOC_CSYS_0049);
    return (0);
}
...
{
    crank_thread_stat_free(crank_thread_stat);
    return (0);
}
...
CSYS_ETH_STAT *csys_eth_stat_new()
{
    ...
    alloc_static_mem(MD_TBD, CMPI_ANY_MODI, MM_CSYS_ETH_STAT, &csys_eth_stat, LOC_CSYS_0057);
...
UINT32 csys_eth_stat_free(CSYS_ETH_STAT *csys_eth_stat)
{
    if(NULL_PTR != csys_eth_stat)
    {
        ...
        free_static_mem(MD_TBD, CMPI_ANY_MODI, MM_CSYS_ETH_STAT, csys_eth_stat, LOC_CSYS_0058);
    }
    return (0);
}
...
CSYS_ETH_VEC *csys_eth_stat_vec_new()
{
    ...
    alloc_static_mem(MD_TBD, CMPI_ANY_MODI, MM_CVECTOR, &csys_eth_stat_vec, LOC_CSYS_0059);
...
UINT32 csys_eth_stat_vec_free(CSYS_ETH_VEC *csys_eth_stat_vec)
{
    ...
    free_static_mem(MD_TBD, CMPI_ANY_MODI, MM_CVECTOR, csys_eth_stat_vec, LOC_CSYS_0062);
    return (0);
}
...
CSYS_DSK_STAT *csys_dsk_stat_new()
{
    ...
    alloc_static_mem(MD_TBD, CMPI_ANY_MODI, MM_CSYS_DSK_STAT, &csys_dsk_stat, LOC_CSYS_0064);
...
UINT32 csys_dsk_stat_free(CSYS_DSK_STAT *csys_dsk_stat)
{
    if(NULL_PTR != csys_dsk_stat)
    {
        ...
        free_static_mem(MD_TBD, CMPI_ANY_MODI, MM_CSYS_DSK_STAT, csys_dsk_stat, LOC_CSYS_0065);
    }
...
CSYS_DSK_VEC *csys_dsk_stat_vec_new()
{
    ...
    alloc_static_mem(MD_TBD, CMPI_ANY_MODI, MM_CVECTOR, &csys_dsk_stat_vec, LOC_CSYS_0066);
...
UINT32 csys_dsk_stat_vec_free(CSYS_DSK_VEC *csys_dsk_stat_vec)
{
    ...
    free_static_mem(MD_TBD, CMPI_ANY_MODI, MM_CVECTOR, csys_dsk_stat_vec, LOC_CSYS_0069);
    return (0);
}
...
CRANK_TASK_REPORT_VEC *crank_task_report_vec_new()
{
    ...
    alloc_static_mem(MD_TBD, CMPI_ANY_MODI, MM_CVECTOR, &crank_task_report_vec, LOC_CSYS_0077);
...
UINT32 crank_task_report_vec_free(CRANK_TASK_REPORT_VEC *crank_task_report_vec)
{
    if(NULL_PTR != crank_task_report_vec)
    {
        ...
        free_static_mem(MD_TBD, CMPI_ANY_MODI, MM_CVECTOR, crank_task_report_vec, LOC_CSYS_0080);
    }
    return (0);
}
