...
UINT32 crfsc_start(const CSTRING *crfs_root_dir)
{
    ...
    if(ERR_MODULE_ID == crfsc_md_id)
    {
        return (ERR_MODULE_ID);
    }

    /* initilize new one CRFSC module */
    ...
    if(SWITCH_ON == CRFSCHTTP_SWITCH && CMPI_FWD_RANK == CMPI_LOCAL_RANK)
    {
        if(EC_TRUE == task_brd_default_check_csrv_enabled())
        {
            ...
            task_brd_default_start_crfschttp_srv(crfsc_md_id, task_brd_default_get_srv_ipaddr(), task_brd_default_get_csrv_port());
        }
    }    
...
EC_BOOL crfsc_find_dir(const UINT32 crfsc_md_id, const CSTRING *dir_path)
{
    ...
    for(crfs_mod_node_idx = 0; crfs_mod_node_idx < crfs_mod_node_num; crfs_mod_node_idx ++)
    {
        ...
        alloc_static_mem(MD_TASK, CMPI_ANY_MODI, MM_UINT32, &ret, LOC_CRFSC_0010);
        cvector_push(ret_vec, (void *)ret);
        (*ret) = EC_FALSE;/*init*/

        task_p2p_inc(task_mgr, crfsc_md_id, recv_mod_node, ret, FI_crfsc_find_dir_ep, ERR_MODULE_ID, dir_path);
    }
    ...
    for(crfs_mod_node_idx = 0; crfs_mod_node_idx < crfs_mod_node_num; crfs_mod_node_idx ++)
    {
        ...
        if(EC_TRUE == result)
        {
            free_static_mem(MD_TASK, CMPI_ANY_MODI, MM_UINT32, ret, LOC_CRFSC_0011);
        ...
        if(EC_FALSE == (*ret))
        {
            free_static_mem(MD_TASK, CMPI_ANY_MODI, MM_UINT32, ret, LOC_CRFSC_0012);
            cvector_set(ret_vec, crfs_mod_node_idx, NULL_PTR); 
            continue;
        }
        ...
        free_static_mem(MD_TASK, CMPI_ANY_MODI, MM_UINT32, ret, LOC_CRFSC_0013);
        cvector_set(ret_vec, crfs_mod_node_idx, NULL_PTR); 
    }
...
EC_BOOL crfsc_find_file(const UINT32 crfsc_md_id, const CSTRING *file_path)
{
    ...
    task_p2p(crfsc_md_id, TASK_DEFAULT_LIVE, TASK_PRIO_NORMAL, TASK_NEED_RSP_FLAG, TASK_NEED_ALL_RSP, 
             &recv_mod_node, 
             &result, FI_crfsc_find_file_ep, ERR_MODULE_ID, file_path);
...
EC_BOOL crfsc_find_file_b(const UINT32 crfsc_md_id, const CSTRING *file_path)
{
    ...
    task_p2p(crfsc_md_id, TASK_DEFAULT_LIVE, TASK_PRIO_NORMAL, TASK_NEED_RSP_FLAG, TASK_NEED_ALL_RSP, 
             &recv_mod_node, \
             &result, FI_crfsc_find_file_b_ep, ERR_MODULE_ID, file_path);
...
EC_BOOL crfsc_write(const UINT32 crfsc_md_id, const CSTRING *file_path, const CBYTES *cbytes, const UINT32 expire_nsec)
{
    ...
    task_p2p(crfsc_md_id, TASK_DEFAULT_LIVE, TASK_PRIO_NORMAL, TASK_NEED_RSP_FLAG, TASK_NEED_ALL_RSP, 
             &recv_mod_node, 
             &result, FI_crfsc_write_ep, ERR_MODULE_ID, file_path, cbytes, expire_nsec);
...
EC_BOOL crfsc_read(const UINT32 crfsc_md_id, const CSTRING *file_path, CBYTES *cbytes, UINT32 *expires_timestamp, const EC_BOOL need_expired_content)
{
    ...
    task_p2p(crfsc_md_id, TASK_DEFAULT_LIVE, TASK_PRIO_NORMAL, TASK_NEED_RSP_FLAG, TASK_NEED_ALL_RSP, 
             &recv_mod_node, 
             &result, FI_crfsc_read_ep, ERR_MODULE_ID, file_path, cbytes, expires_timestamp, need_expired_content);
...
EC_BOOL crfsc_write_e(const UINT32 crfsc_md_id, const CSTRING *file_path, UINT32 *offset, const UINT32 max_len, const CBYTES *cbytes)
{
    ...
    task_p2p(crfsc_md_id, TASK_DEFAULT_LIVE, TASK_PRIO_NORMAL, TASK_NEED_RSP_FLAG, TASK_NEED_ALL_RSP, 
             &recv_mod_node, 
             &result, FI_crfsc_write_e_ep, ERR_MODULE_ID, file_path, offset, max_len, cbytes);
...
EC_BOOL crfsc_read_e(const UINT32 crfsc_md_id, const CSTRING *file_path, UINT32 *offset, const UINT32 max_len, CBYTES *cbytes, UINT32 *expires_timestamp, const EC_BOOL need_expired_content)
{
    ...
    task_p2p(crfsc_md_id, TASK_DEFAULT_LIVE, TASK_PRIO_NORMAL, TASK_NEED_RSP_FLAG, TASK_NEED_ALL_RSP, 
             &recv_mod_node, 
             &result, FI_crfsc_read_e_ep, ERR_MODULE_ID, file_path, offset, max_len, cbytes, expires_timestamp, need_expired_content);
...
EC_BOOL crfsc_create_b(const UINT32 crfsc_md_id, const CSTRING *file_path, const uint64_t *file_size)
{
    ...
    task_p2p(crfsc_md_id, TASK_DEFAULT_LIVE, TASK_PRIO_NORMAL, TASK_NEED_RSP_FLAG, TASK_NEED_ALL_RSP, 
             &recv_mod_node, 
             &result, FI_crfsc_create_b_ep, ERR_MODULE_ID, file_path, file_size);
...
EC_BOOL crfsc_write_b(const UINT32 crfsc_md_id, const CSTRING *file_path, uint64_t *offset, const CBYTES *cbytes)
{
    ...
    task_p2p(crfsc_md_id, TASK_DEFAULT_LIVE, TASK_PRIO_NORMAL, TASK_NEED_RSP_FLAG, TASK_NEED_ALL_RSP, 
             &recv_mod_node, 
             &result, FI_crfsc_write_b_ep, ERR_MODULE_ID, file_path, offset, cbytes);
...
EC_BOOL crfsc_read_b(const UINT32 crfsc_md_id, const CSTRING *file_path, uint64_t *offset, const UINT32 max_len, CBYTES *cbytes, UINT32 *expires_timestamp, const EC_BOOL need_expired_content)
{
    ...
    task_p2p(crfsc_md_id, TASK_DEFAULT_LIVE, TASK_PRIO_NORMAL, TASK_NEED_RSP_FLAG, TASK_NEED_ALL_RSP, 
             &recv_mod_node, 
             &result, FI_crfsc_read_b_ep, ERR_MODULE_ID, file_path, offset, max_len, cbytes, expires_timestamp, need_expired_content);
...
EC_BOOL crfsc_renew(const UINT32 crfsc_md_id, const CSTRING *file_path, const UINT32 expires_timestamp)
{
    ...
    task_p2p(crfsc_md_id, TASK_DEFAULT_LIVE, TASK_PRIO_NORMAL, TASK_NEED_RSP_FLAG, TASK_NEED_ALL_RSP, 
             &recv_mod_node, 
             &result, FI_crfsc_renew_ep, ERR_MODULE_ID, file_path, expires_timestamp);
...
EC_BOOL crfsc_delete_file(const UINT32 crfsc_md_id, const CSTRING *file_path)
{
    ...
    task_p2p(crfsc_md_id, TASK_DEFAULT_LIVE, TASK_PRIO_NORMAL, TASK_NEED_RSP_FLAG, TASK_NEED_ALL_RSP, 
             &recv_mod_node, 
             &result, FI_crfsc_delete_file_ep, ERR_MODULE_ID, file_path);
...
EC_BOOL crfsc_delete_file_b(const UINT32 crfsc_md_id, const CSTRING *file_path)
{
    ...
    task_p2p(crfsc_md_id, TASK_DEFAULT_LIVE, TASK_PRIO_NORMAL, TASK_NEED_RSP_FLAG, TASK_NEED_ALL_RSP, 
             &recv_mod_node, 
             &result, FI_crfsc_delete_file_b_ep, ERR_MODULE_ID, file_path);
...
EC_BOOL crfsc_delete_dir(const UINT32 crfsc_md_id, const CSTRING *dir_path)
{
    ...
    for(crfs_mod_node_idx = 0; crfs_mod_node_idx < crfs_mod_node_num; crfs_mod_node_idx ++)
    {
        ...
        alloc_static_mem(MD_TASK, CMPI_ANY_MODI, MM_UINT32, &ret, LOC_CRFSC_0016);
        cvector_push(ret_vec, (void *)ret);
        (*ret) = EC_FALSE;/*init*/

        task_p2p_inc(task_mgr, crfsc_md_id, recv_mod_node, ret, FI_crfsc_delete_dir_ep, ERR_MODULE_ID, dir_path);
    }
    ...
    for(crfs_mod_node_idx = 0; crfs_mod_node_idx < crfs_mod_node_num; crfs_mod_node_idx ++)
    {
        ...
        if(EC_TRUE == (*ret))
        {
            free_static_mem(MD_TASK, CMPI_ANY_MODI, MM_UINT32, ret, LOC_CRFSC_0017);
            cvector_set(ret_vec, crfs_mod_node_idx, NULL_PTR); 
            continue;
        }
        ...
        free_static_mem(MD_TASK, CMPI_ANY_MODI, MM_UINT32, ret, LOC_CRFSC_0018);
        cvector_set(ret_vec, crfs_mod_node_idx, NULL_PTR); 
    }
...
EC_BOOL crfsc_update(const UINT32 crfsc_md_id, const CSTRING *file_path, const CBYTES *cbytes, const UINT32 expire_nsec)
{
    ...
    task_p2p(crfsc_md_id, TASK_DEFAULT_LIVE, TASK_PRIO_NORMAL, TASK_NEED_RSP_FLAG, TASK_NEED_ALL_RSP, 
             &recv_mod_node, 
             &result, FI_crfsc_update_ep, ERR_MODULE_ID, file_path, cbytes, expire_nsec);
...
EC_BOOL crfsc_qfile(const UINT32 crfsc_md_id, const CSTRING *file_path, CRFSNP_ITEM  *crfsnp_item)
{
    ...
    task_p2p(crfsc_md_id, TASK_DEFAULT_LIVE, TASK_PRIO_NORMAL, TASK_NEED_RSP_FLAG, TASK_NEED_ALL_RSP, 
             &recv_mod_node, 
             &result, FI_crfsc_qfile_ep, ERR_MODULE_ID, file_path, crfsnp_item);
...
EC_BOOL crfsc_file_size(const UINT32 crfsc_md_id, const CSTRING *file_path, uint64_t *file_size)
{
    ...
    task_p2p(crfsc_md_id, TASK_DEFAULT_LIVE, TASK_PRIO_NORMAL, TASK_NEED_RSP_FLAG, TASK_NEED_ALL_RSP, 
             &recv_mod_node, 
             &result, FI_crfsc_file_size_ep, ERR_MODULE_ID, file_path, file_size);
...
EC_BOOL crfsc_store_size_b(const UINT32 crfsc_md_id, const CSTRING *file_path, uint64_t *store_size, UINT32 *expires_timestamp)
{
    ...
    task_p2p(crfsc_md_id, TASK_DEFAULT_LIVE, TASK_PRIO_NORMAL, TASK_NEED_RSP_FLAG, TASK_NEED_ALL_RSP, 
             &recv_mod_node, 
             &result, FI_crfsc_store_size_b_ep, ERR_MODULE_ID, file_path, store_size, expires_timestamp);
...
EC_BOOL crfsc_file_md5sum(const UINT32 crfsc_md_id, const CSTRING *file_path, CMD5_DIGEST *md5sum)
{
    ...
    task_p2p(crfsc_md_id, TASK_DEFAULT_LIVE, TASK_PRIO_NORMAL, TASK_NEED_RSP_FLAG, TASK_NEED_ALL_RSP, 
             &recv_mod_node, 
             &result, FI_crfsc_file_md5sum_ep, ERR_MODULE_ID, file_path, md5sum);
...
EC_BOOL crfsc_file_md5sum_b(const UINT32 crfsc_md_id, const CSTRING *file_path, const UINT32 seg_no, CMD5_DIGEST *md5sum)
{
    ...
    task_p2p(crfsc_md_id, TASK_DEFAULT_LIVE, TASK_PRIO_NORMAL, TASK_NEED_RSP_FLAG, TASK_NEED_ALL_RSP, 
             &recv_mod_node, 
             &result, FI_crfsc_file_md5sum_b_ep, ERR_MODULE_ID, file_path, seg_no, md5sum);
...
EC_BOOL crfsc_recycle_ep(const UINT32 crfsc_md_id)
{
    ...
    for(crfs_pos = 0; crfs_pos < crfs_num; crfs_pos ++)
    {
        ...
        if(EC_FALSE == crfs_recycle(crfs_md_id))
        {
            result = EC_FALSE;
...
EC_BOOL crfsc_recycle(const UINT32 crfsc_md_id)
{
    ...
    for(crfs_mod_node_idx = 0; crfs_mod_node_idx < crfs_mod_node_num; crfs_mod_node_idx ++)
    {
        ...
        alloc_static_mem(MD_TASK, CMPI_ANY_MODI, MM_UINT32, &ret, LOC_CRFSC_0021);
        cvector_push(ret_vec, (void *)ret);
        (*ret) = EC_FALSE;/*init*/

        task_p2p_inc(task_mgr, crfsc_md_id, recv_mod_node, ret, FI_crfsc_recycle_ep, ERR_MODULE_ID);
    }
    ...
    for(crfs_mod_node_idx = 0; crfs_mod_node_idx < crfs_mod_node_num; crfs_mod_node_idx ++)
    {
        ...
        if(EC_TRUE == (*ret))
        {
            free_static_mem(MD_TASK, CMPI_ANY_MODI, MM_UINT32, ret, LOC_CRFSC_0022);
            cvector_set(ret_vec, crfs_mod_node_idx, NULL_PTR); 
            continue;
        }
        ...
        free_static_mem(MD_TASK, CMPI_ANY_MODI, MM_UINT32, ret, LOC_CRFSC_0023);
        cvector_set(ret_vec, crfs_mod_node_idx, NULL_PTR); 
    }
...
EC_BOOL crfsc_trans_dir_pre(const UINT32 crfsc_md_id, const CSTRING *dir_path)
{
    ...
    for(crfs_mod_node_idx = 0; crfs_mod_node_idx < crfs_mod_node_num; crfs_mod_node_idx ++)
    {
        ...
        alloc_static_mem(MD_TASK, CMPI_ANY_MODI, MM_UINT32, &ret, LOC_CRFSC_0026);
        cvector_push(ret_vec, (void *)ret);
        (*ret) = EC_FALSE;/*init*/

        task_p2p_inc(task_mgr, crfsc_md_id, recv_mod_node, ret, FI_crfsc_trans_dir_pre_ep, ERR_MODULE_ID, dir_path, crfsdt_pnode_des);
    }
    ...
    for(crfs_mod_node_idx = 0; crfs_mod_node_idx < crfs_mod_node_num; crfs_mod_node_idx ++)
    {
        ...
        if(EC_TRUE == (*ret))
        {
            free_static_mem(MD_TASK, CMPI_ANY_MODI, MM_UINT32, ret, LOC_CRFSC_0027);
            cvector_set(ret_vec, crfs_mod_node_idx, NULL_PTR); 
            continue;
        }
        ...
        free_static_mem(MD_TASK, CMPI_ANY_MODI, MM_UINT32, ret, LOC_CRFSC_0028);
        cvector_set(ret_vec, crfs_mod_node_idx, NULL_PTR); 
    }
...
EC_BOOL crfsc_trans_dir_handle(const UINT32 crfsc_md_id, const CSTRING *dir_path)
{
    ...
    for(crfs_mod_node_idx = 0; crfs_mod_node_idx < crfs_mod_node_num; crfs_mod_node_idx ++)
    {
        ...
        alloc_static_mem(MD_TASK, CMPI_ANY_MODI, MM_UINT32, &ret, LOC_CRFSC_0031);
        cvector_push(ret_vec, (void *)ret);
        (*ret) = EC_FALSE;/*init*/

        task_p2p_inc(task_mgr, crfsc_md_id, recv_mod_node, ret, FI_crfsc_trans_dir_handle_ep, ERR_MODULE_ID, dir_path, crfsdt_pnode_des);
    }
    ...
    for(crfs_mod_node_idx = 0; crfs_mod_node_idx < crfs_mod_node_num; crfs_mod_node_idx ++)
    {
        ...
        if(EC_TRUE == (*ret))
        {
            free_static_mem(MD_TASK, CMPI_ANY_MODI, MM_UINT32, ret, LOC_CRFSC_0032);
            cvector_set(ret_vec, crfs_mod_node_idx, NULL_PTR); 
            continue;
        }
        ...
        free_static_mem(MD_TASK, CMPI_ANY_MODI, MM_UINT32, ret, LOC_CRFSC_0033);
        cvector_set(ret_vec, crfs_mod_node_idx, NULL_PTR); 
    }
...
EC_BOOL crfsc_trans_dir_post(const UINT32 crfsc_md_id, const CSTRING *dir_path)
{
    ...
    for(crfs_mod_node_idx = 0; crfs_mod_node_idx < crfs_mod_node_num; crfs_mod_node_idx ++)
    {
        ...
        alloc_static_mem(MD_TASK, CMPI_ANY_MODI, MM_UINT32, &ret, LOC_CRFSC_0036);
        cvector_push(ret_vec, (void *)ret);
        (*ret) = EC_FALSE;/*init*/

        task_p2p_inc(task_mgr, crfsc_md_id, recv_mod_node, ret, FI_crfsc_trans_dir_post_ep, ERR_MODULE_ID, dir_path, crfsdt_pnode_des);
    }
    ...
    for(crfs_mod_node_idx = 0; crfs_mod_node_idx < crfs_mod_node_num; crfs_mod_node_idx ++)
    {
        ...
        if(EC_TRUE == (*ret))
        {
            free_static_mem(MD_TASK, CMPI_ANY_MODI, MM_UINT32, ret, LOC_CRFSC_0037);
            cvector_set(ret_vec, crfs_mod_node_idx, NULL_PTR); 
            continue;
        }
        ...
        free_static_mem(MD_TASK, CMPI_ANY_MODI, MM_UINT32, ret, LOC_CRFSC_0038);
        cvector_set(ret_vec, crfs_mod_node_idx, NULL_PTR); 
    }
...
EC_BOOL crfsc_trans_dir_recycle(const UINT32 crfsc_md_id, const CSTRING *dir_path)
{
    ...
    for(crfs_mod_node_idx = 0; crfs_mod_node_idx < crfs_mod_node_num; crfs_mod_node_idx ++)
    {
        ...
        alloc_static_mem(MD_TASK, CMPI_ANY_MODI, MM_UINT32, &ret, LOC_CRFSC_0041);
        cvector_push(ret_vec, (void *)ret);
        (*ret) = EC_FALSE;/*init*/

        task_p2p_inc(task_mgr, crfsc_md_id, recv_mod_node, ret, FI_crfsc_trans_dir_recycle_ep, ERR_MODULE_ID, dir_path, crfsdt_pnode_des);
    }
    ...
    for(crfs_mod_node_idx = 0; crfs_mod_node_idx < crfs_mod_node_num; crfs_mod_node_idx ++)
    {
        ...
        if(EC_TRUE == (*ret))
        {
            free_static_mem(MD_TASK, CMPI_ANY_MODI, MM_UINT32, ret, LOC_CRFSC_0042);
            cvector_set(ret_vec, crfs_mod_node_idx, NULL_PTR); 
            continue;
        }
        ...
        free_static_mem(MD_TASK, CMPI_ANY_MODI, MM_UINT32, ret, LOC_CRFSC_0043);
        cvector_set(ret_vec, crfs_mod_node_idx, NULL_PTR); 
    }
...
EC_BOOL crfsc_trans_dir_whole(const UINT32 crfsc_md_id, const CSTRING *dir_path)
{
    ...
    for(crfs_mod_node_idx = 0; crfs_mod_node_idx < crfs_mod_node_num; crfs_mod_node_idx ++)
    {
        ...
        alloc_static_mem(MD_TASK, CMPI_ANY_MODI, MM_UINT32, &ret, LOC_CRFSC_0046);
        cvector_push(ret_vec, (void *)ret);
        (*ret) = EC_FALSE;/*init*/

        task_p2p_inc(task_mgr, crfsc_md_id, recv_mod_node, ret, FI_crfsc_trans_dir_whole_ep, ERR_MODULE_ID, dir_path, crfsdt_pnode_des);
    }
    ...
    for(crfs_mod_node_idx = 0; crfs_mod_node_idx < crfs_mod_node_num; crfs_mod_node_idx ++)
    {
        ...
        if(EC_TRUE == (*ret))
        {
            free_static_mem(MD_TASK, CMPI_ANY_MODI, MM_UINT32, ret, LOC_CRFSC_0047);
            cvector_set(ret_vec, crfs_mod_node_idx, NULL_PTR); 
            continue;
        }
        ...
        free_static_mem(MD_TASK, CMPI_ANY_MODI, MM_UINT32, ret, LOC_CRFSC_0048);
        cvector_set(ret_vec, crfs_mod_node_idx, NULL_PTR); 
    }
