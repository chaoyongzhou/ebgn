...
static void __cbgt_print_chars(LOG *log, const uint8_t *buf, const uint32_t len);
...
static EC_BOOL __cbgt_make_default_row_of_colf_table(const UINT32 cbgt_md_id, CBYTES *colf_row)
{
    ...
    cbytes_clean(&start_user_rowkey, LOC_CBGT_0006);
    cbytes_clean(&end_user_rowkey, LOC_CBGT_0007);
...
static MOD_MGR *__cbgt_gen_mod_mgr(const UINT32 cbgt_md_id, const UINT32 server_type, const UINT32 incl_tcid, const UINT32 incl_rank, const UINT32 excl_tcid, const UINT32 excl_rank)
{
    ...
    CVECTOR_LOCK(cluster_vec, LOC_CBGT_0009);
    ...
    CVECTOR_UNLOCK(cluster_vec, LOC_CBGT_0010);
#endif
    ...
    cvector_free(tcid_vec, LOC_CBGT_0011);
...
EC_BOOL __cbgt_load_root_record_file(const UINT32 cbgt_md_id, const CSTRING *root_path, UINT32 *root_table_id, MOD_NODE *root_mod_node)
{
    ...
    cstring_free(root_record_file_name);
    cbytes_free(cbytes, LOC_CBGT_0014);
    return (EC_TRUE);
...
#if (SWITCH_OFF == CBGT_BASED_ON_HSDFS_SWITCH)
    CBGT_MD_CDFS_MD_ID(cbgt_md) = ERR_MODULE_ID;
#endif/*(SWITCH_OFF == CBGT_BASED_ON_HSDFS_SWITCH)*/
    return (EC_TRUE);
}
...
static EC_BOOL __cbgt_end_csession(const UINT32 cbgt_md_id)
{
    ...
    if(ERR_MODULE_ID != CBGT_MD_CSESSION_MD_ID(cbgt_md))
    {
        ...
        CBGT_MD_CSESSION_MD_ID(cbgt_md) = ERR_MODULE_ID;
    }
    return (EC_TRUE);
}
...
UINT32 cbgt_start(const UINT32 server_type, const UINT32 table_id, const CBYTES *table_name, const MOD_NODE *parent, const CSTRING *root_path, const UINT32 open_flags)
{
    ...
    CBGT_MD_INIT_TABLE_CRWLOCK(cbgt_md, LOC_CBGT_0018);
    CBGT_MD_INIT_TABLE_ID_POOL_CMUTEX(cbgt_md, LOC_CBGT_0019);
    CBGT_MD_INIT_LAST_ACCESS_TIME_CMUTEX(cbgt_md, LOC_CBGT_0020);
    ...
    if(CBGT_TYPE_COLF_SERVER == server_type && NULL_PTR != gdb && EC_TRUE == cbgt_gdb_is_empty(gdb))
    {
        ...
        cbytes_clean(&colf_row, LOC_CBGT_0023);
    }
...
void cbgt_end(const UINT32 cbgt_md_id)
{
    ...
    //CBGT_MD_CRWLOCK_TABLE_WRLOCK(cbgt_md, LOC_CBGT_0025);
    ...
    if(NULL_PTR != CBGT_MD_MOD_MGR(cbgt_md))
    {
        ...
        task_dea(CBGT_MD_MOD_MGR(cbgt_md), TASK_DEFAULT_LIVE, TASK_PRIO_NORMAL, FI_cbgt_end, ERR_MODULE_ID);
    ...
    {
        cbytes_free(CBGT_MD_TABLE_NAME(cbgt_md), LOC_CBGT_0026);
        CBGT_MD_TABLE_NAME(cbgt_md) = NULL_PTR;
    }

    /* free module : */
    //cbgt_free_module_static_mem(cbgt_md_id);
    //CBGT_MD_CRWLOCK_TABLE_UNLOCK(cbgt_md, LOC_CBGT_0027);

    CBGT_MD_CLEAN_TABLE_CRWLOCK(cbgt_md, LOC_CBGT_0028);
    CBGT_MD_CLEAN_TABLE_ID_POOL_CMUTEX(cbgt_md, LOC_CBGT_0029);
...
EC_BOOL cbgt_aging_handle(const UINT32 cbgt_md_id)
{
    ...
    {
        CBGT_MD_WAS_ACCESS(cbgt_md, LOC_CBGT_0031);
        return (EC_TRUE);
    }
...
MOD_MGR * cbgt_get_mod_mgr(const UINT32 cbgt_md_id)
{
    ...
    cbgt_md = CBGT_MD_GET(cbgt_md_id);
    CBGT_MD_WAS_ACCESS(cbgt_md, LOC_CBGT_0033);
...
EC_BOOL cbgt_gdb_init(CBGT_GDB *gdb)
{
    ...
    CBGT_GDB_CRWLOCK_INIT(gdb, LOC_CBGT_0035);
    return (EC_TRUE);
}
...
EC_BOOL cbgt_gdb_clean(CBGT_GDB *gdb)
{
    ...
    CBGT_GDB_CDFS_MD_ID(gdb) = ERR_MODULE_ID;  
    CBGT_GDB_TYPE(gdb)       = CBGT_TYPE_UNDEF;
    CBGT_GDB_CRWLOCK_CLEAN(gdb, LOC_CBGT_0036);
    return (EC_TRUE);
}
...
EC_BOOL cbgt_gdb_free(CBGT_GDB *gdb)
{
    ...
    {
        cbgt_gdb_clean(gdb);
        free_static_mem(MD_CBGT, CMPI_ANY_MODI, MM_CBGT_GDB, gdb, LOC_CBGT_0037);
    }
    return (EC_TRUE);
}
...
EC_BOOL cbgt_gdb_flush(CBGT_GDB *gdb)
{
    ...
    CBGT_GDB_CRWLOCK_WRLOCK(gdb, LOC_CBGT_0043);
    ...
    CBGT_GDB_CRWLOCK_UNLOCK(gdb, LOC_CBGT_0047);
    return (EC_TRUE);
}
...
EC_BOOL cbgt_gdb_unlink(CBGT_GDB *gdb, const CSTRING *root_path, const UINT32 table_id)
{
    ...
    CBGT_GDB_CRWLOCK_WRLOCK(gdb, LOC_CBGT_0048);
...
EC_BOOL cbgt_gdb_flush(CBGT_GDB *gdb)
{
    ...
    CBGT_GDB_CRWLOCK_WRLOCK(gdb, LOC_CBGT_0059);
    if(EC_FALSE == cbtree_is_dirty(CBGT_GDB_CBTREE(gdb)))
    {
    ...
    encoded_buff = (uint8_t *)safe_malloc(encoded_size, LOC_CBGT_0062);
    ...
    compressed_buff = (uint8_t *)safe_malloc(compressed_len + sizeof(uint32_t), LOC_CBGT_0066);
    ...
    if(Z_OK != compress(compressed_buff + counter, &compressed_len, encoded_buff, encoded_pos))
    {
        ...
        safe_free(encoded_buff, LOC_CBGT_0070);
        safe_free(compressed_buff, LOC_CBGT_0071);        
        return (EC_FALSE);
    }
    ...
    CBGT_GDB_CRWLOCK_UNLOCK(gdb, LOC_CBGT_0075);
    
    cbytes_umount(&cbytes);
    safe_free(compressed_buff, LOC_CBGT_0076);
    return (EC_TRUE);
}
...
EC_BOOL cbgt_gdb_unlink(CBGT_GDB *gdb, const CSTRING *root_path, const UINT32 table_id)
{
    ...
    CBGT_GDB_CRWLOCK_WRLOCK(gdb, LOC_CBGT_0077);
    fname = __cbgt_gen_table_fame(cstring_get_str(root_path), table_id);
    if(NULL_PTR == fname)
    {
    ...
    safe_free(fname, LOC_CBGT_0081);
    CBGT_GDB_CRWLOCK_UNLOCK(gdb, LOC_CBGT_0082);
    return (EC_TRUE);
}
#endif/*(SWITCH_ON == CBGT_BASED_ON_HSDFS_SWITCH)*/
...
EC_BOOL cbgt_gdb_insert_key(CBGT_GDB *gdb, const uint8_t *key)
{
    ...
    CBGT_GDB_CRWLOCK_UNLOCK(gdb, LOC_CBGT_0085);
    return (EC_TRUE);
}
...
CBTREE_KEY *cbgt_gdb_search_key(const CBGT_GDB *gdb, const uint8_t *key)
{
    ...
    CBGT_GDB_CRWLOCK_UNLOCK((CBGT_GDB *)gdb, LOC_CBGT_0087);
    return (cbtree_key);
}
...
EC_BOOL cbgt_gdb_split(CBGT_GDB *old_gdb, CBGT_GDB *left_gdb)
{
    ...
    CBGT_GDB_CRWLOCK_WRLOCK(old_gdb, LOC_CBGT_0092);
    ...
    CBGT_GDB_CRWLOCK_UNLOCK(old_gdb, LOC_CBGT_0094);
...
EC_BOOL cbgt_is_root_server(const UINT32 cbgt_md_id)
{
    ...
    cbgt_md = CBGT_MD_GET(cbgt_md_id);
    CBGT_MD_WAS_ACCESS(cbgt_md, LOC_CBGT_0095);
...
EC_BOOL cbgt_is_colf_server(const UINT32 cbgt_md_id)
{
    ...
    cbgt_md = CBGT_MD_GET(cbgt_md_id);
    CBGT_MD_WAS_ACCESS(cbgt_md, LOC_CBGT_0097);
...
EC_BOOL cbgt_is_user_server(const UINT32 cbgt_md_id)
{
    ...
    cbgt_md = CBGT_MD_GET(cbgt_md_id);
    CBGT_MD_WAS_ACCESS(cbgt_md, LOC_CBGT_0098);
...
EC_BOOL cbgt_is_user_client(const UINT32 cbgt_md_id)
{
    ...
    cbgt_md = CBGT_MD_GET(cbgt_md_id);
    CBGT_MD_WAS_ACCESS(cbgt_md, LOC_CBGT_0099);
...
EC_BOOL cbgt_check_exist(const UINT32 cbgt_md_id, const UINT32 table_id, const MOD_NODE *mod_node)
{
    ...
    task_p2p(cbgt_md_id, TASK_DEFAULT_LIVE, TASK_PRIO_NORMAL, TASK_NEED_RSP_FLAG, TASK_NEED_ALL_RSP,
             mod_node,
             &remote_table_id, FI_cbgt_fetch_table_id, ERR_MODULE_ID);
...
EC_BOOL cbgt_kv_clean(const UINT32 cbgt_md_id, CBYTES *kv)
{
    ...
    {
        kvFreeHs(cbytes_buf(kv), LOC_CBGT_0101);
        cbytes_umount(kv);
    }
    return (EC_TRUE);
}
...
EC_BOOL cbgt_key_clean(const UINT32 cbgt_md_id, CBYTES *key)
{
    ...
    {
        keyFreeHs(cbytes_buf(key), LOC_CBGT_0104);
        cbytes_umount(key);
    }
    return (EC_TRUE);
}
...
EC_BOOL cbgt_reserve_table_id(const UINT32 cbgt_md_id, UINT32 *table_id)
{
    ...
    if(EC_TRUE == cbgt_is_root_server(cbgt_md_id))
    {
        ...
        CBGT_MD_CMUTEX_TABLE_ID_POOL_LOCK(cbgt_md, LOC_CBGT_0107);
...
EC_BOOL cbgt_release_table_id(const UINT32 cbgt_md_id, const UINT32 table_id)
{
    ...
    parent  = CBGT_MD_PARENT_MOD(cbgt_md);
    table_id_pool = CBGT_MD_TABLE_ID_POOL(cbgt_md);
    CBGT_MD_WAS_ACCESS(cbgt_md, LOC_CBGT_0110);

    if(EC_TRUE == cbgt_is_root_server(cbgt_md_id))
    {
        CBGT_MD_CMUTEX_TABLE_ID_POOL_LOCK(cbgt_md, LOC_CBGT_0111);
...
EC_BOOL cbgt_get_root_mod_node(const UINT32 cbgt_md_id, MOD_NODE *mod_node)
{
    ...
    cbgt_md = CBGT_MD_GET(cbgt_md_id);
    parent  = CBGT_MD_PARENT_MOD(cbgt_md);
    CBGT_MD_WAS_ACCESS(cbgt_md, LOC_CBGT_0114);
                                ...
                                const CBYTES *right_row, const UINT32 right_table_id, const MOD_NODE *right_mod_node)
{
    ...
    if(EC_FALSE == cbgt_delete_kv_no_lock(cbgt_md_id, &rowkey))
    {
        ...
        sys_print(LOGSTDOUT, "\n");
        cbytes_clean(&rowkey, LOC_CBGT_0116);
        return (EC_FALSE);
    }
    ...
    if(EC_FALSE == cbgt_insert_register_no_lock(cbgt_md_id, right_row, right_table_id, right_mod_node))
    {
        ...
        if(EC_FALSE == cbgt_delete_kv_no_lock(cbgt_md_id, &rowkey))
        {
            ...
            __cbgt_print_colf_table_key(LOGSTDOUT, cbytes_buf(&rowkey));
            sys_print(LOGSTDOUT, "\n");
            cbytes_clean(&rowkey, LOC_CBGT_0118);
            return (EC_FALSE);
        }
        cbytes_clean(&rowkey, LOC_CBGT_0119);
                                ...
                                const CBYTES *right_row, const UINT32 right_table_id, const MOD_NODE *right_mod_node)
{
    ...
    sys_print(LOGSTDOUT, "\n");
#endif
    CBGT_MD_CRWLOCK_TABLE_WRLOCK(cbgt_md, LOC_CBGT_0121);
    ...
    {
        CBGT_MD_CRWLOCK_TABLE_UNLOCK(cbgt_md, LOC_CBGT_0122);
        return (EC_FALSE);
    }
    CBGT_MD_CRWLOCK_TABLE_UNLOCK(cbgt_md, LOC_CBGT_0123);
                                ...
                                const CBYTES *des_row  , const UINT32 des_table_id  , const MOD_NODE *des_mod_node )
{
    ...
    cbytes_clean(&rowkey, LOC_CBGT_0126);
    ...
    if(EC_FALSE == cbgt_delete_kv_no_lock(cbgt_md_id, &rowkey))
    {
        ...
        cbytes_clean(&rowkey, LOC_CBGT_0127);
        return (EC_FALSE);
    }
    cbytes_clean(&rowkey, LOC_CBGT_0128);
                                ...
                                const CBYTES *des_row  , const UINT32 des_table_id  , const MOD_NODE *des_mod_node )
{
    ...
    cbgt_md = CBGT_MD_GET(cbgt_md_id);
    CBGT_MD_WAS_ACCESS(cbgt_md, LOC_CBGT_0129);

    CBGT_MD_CRWLOCK_TABLE_WRLOCK(cbgt_md, LOC_CBGT_0130);
    if(EC_FALSE == cbgt_merge_register_no_lock(cbgt_md_id,
                                                left_row , left_table_id , left_mod_node,
                                                right_row, right_table_id, right_mod_node,
                                                des_row  , des_table_id  , des_mod_node))
    {
        CBGT_MD_CRWLOCK_TABLE_UNLOCK(cbgt_md, LOC_CBGT_0131);
        return (EC_FALSE);
    }
    CBGT_MD_CRWLOCK_TABLE_UNLOCK(cbgt_md, LOC_CBGT_0132);
...
EC_BOOL cbgt_delete_kv_no_lock(const UINT32 cbgt_md_id, const CBYTES *key_bytes)
{
    ...
    cbgt_md = CBGT_MD_GET(cbgt_md_id);
    CBGT_MD_WAS_ACCESS(cbgt_md, LOC_CBGT_0133);
...
EC_BOOL cbgt_delete_kv(const UINT32 cbgt_md_id, const CBYTES *key_bytes)
{
    ...
    cbgt_md = CBGT_MD_GET(cbgt_md_id);
    CBGT_MD_WAS_ACCESS(cbgt_md, LOC_CBGT_0134);

    CBGT_MD_CRWLOCK_TABLE_WRLOCK(cbgt_md, LOC_CBGT_0135);
    if(EC_FALSE == cbgt_delete_kv_no_lock(cbgt_md_id, key_bytes))
    {
        CBGT_MD_CRWLOCK_TABLE_UNLOCK(cbgt_md, LOC_CBGT_0136);
        return (EC_FALSE);
    }
    CBGT_MD_CRWLOCK_TABLE_UNLOCK(cbgt_md, LOC_CBGT_0137);
...
static EC_BOOL __cbgt_clean_report_vec_words(const UINT32 cbgt_md_id, CVECTOR *report_vec)
{
    ...
    for(pos = 0; pos < num; pos ++)
    {
        ...
        free_static_mem(MD_CBGT, cbgt_md_id, MM_UINT32, word, LOC_CBGT_0138);
    }
...
EC_BOOL __cbgt_merge_one_group(const UINT32 cbgt_md_id, const CVECTOR *kv_bytes_vec)
{
        ...
        kv_bytes_pos += 2, remote_mod_node_idx ++)
    {
        ...
        if(EC_FALSE == cbgt_fetch_row(cbgt_md_id, kv_bytes, &table_name))
        {
            ...
            cvector_free_no_lock(report_vec, LOC_CBGT_0144);
            return (EC_FALSE);
        }
        ...
        if(EC_FALSE == cbgt_fetch_from_rmc(cbgt_md_id, kv_bytes, &table_id,  &mod_node))
        {
            ...
            task_mgr_free(task_mgr);
            __cbgt_clean_report_vec_words(cbgt_md_id, report_vec);
            cvector_free_no_lock(report_vec, LOC_CBGT_0145);
            return (EC_FALSE);
        }

        alloc_static_mem(MD_CBGT, cbgt_md_id, MM_UINT32, &ret, LOC_CBGT_0146);
        cvector_push_no_lock(report_vec, (void *)ret);
        (*ret) = EC_FALSE;

        task_pos_inc(task_mgr, remote_mod_node_idx, ret, FI_cbgt_merge_table, ERR_MODULE_ID, &table_name, table_id);
    }
    ...
    for(remote_mod_node_idx = 0; remote_mod_node_idx < remote_mod_node_num; remote_mod_node_idx ++)
    {
        ...
        free_static_mem(MD_CBGT, cbgt_md_id, MM_UINT32, ret, LOC_CBGT_0147);
    }
    cvector_free_no_lock(report_vec, LOC_CBGT_0148);
...
EC_BOOL __cbgt_merge_groups(const UINT32 cbgt_md_id)
{
    ...
    cbgt_md = CBGT_MD_GET(cbgt_md_id);
    CBGT_MD_WAS_ACCESS(cbgt_md, LOC_CBGT_0149);
    ...
    cvector_init(&kv_bytes_vec, 0, MM_CBYTES, CVECTOR_LOCK_ENABLE, LOC_CBGT_0150);
        ...
        )
    {
        ...
        cvector_clean_with_location_no_lock(&kv_bytes_vec, (CVECTOR_DATA_LOCATION_CLEANER)cbytes_free, LOC_CBGT_0155);        
    }
    ...
    cvector_clean_with_location_no_lock(&kv_bytes_vec, (CVECTOR_DATA_LOCATION_CLEANER)cbytes_free, LOC_CBGT_0157);
...
EC_BOOL cbgt_merge(const UINT32 cbgt_md_id)
{
    ...
    if(EC_TRUE == cbgt_is_root_server(cbgt_md_id) || EC_TRUE == cbgt_is_meta_server(cbgt_md_id))
    {
        ...
        report_vec = cvector_new(0, MM_UINT32, LOC_CBGT_0159);
        ...
        for(remote_mod_node_idx = 0; remote_mod_node_idx < remote_mod_node_num; remote_mod_node_idx ++)
        {
            ...
            alloc_static_mem(MD_CBGT, cbgt_md_id, MM_UINT32, &ret, LOC_CBGT_0160);
            cvector_push_no_lock(report_vec, (void *)ret);
            (*ret) = EC_FALSE;
        ...
        for(remote_mod_node_idx = 0; remote_mod_node_idx < remote_mod_node_num; remote_mod_node_idx ++)
        {
            ...
            ret = (UINT32 *)cvector_get_no_lock(report_vec, remote_mod_node_idx);
            cvector_set_no_lock(report_vec, remote_mod_node_idx, NULL_PTR);
            free_static_mem(MD_CBGT, cbgt_md_id, MM_UINT32, ret, LOC_CBGT_0161);
        }
        cvector_free_no_lock(report_vec, LOC_CBGT_0162);
    ...
    CBGT_MD_CRWLOCK_TABLE_WRLOCK(cbgt_md, LOC_CBGT_0163);
...
static EC_BOOL __cbgt_split_no_lock(const UINT32 cbgt_md_id, EC_BOOL *split_flag)
{
    ...
    CBGT_MD_WAS_ACCESS(cbgt_md, LOC_CBGT_0166);
    ...
    //CBGT_MD_CRWLOCK_TABLE_WRLOCK(cbgt_md, LOC_CBGT_0167);
    ...
    safe_free(last_user_rowkey, LOC_CBGT_0175);

    ret = EC_FALSE;
    task_p2p(cbgt_md_id, TASK_DEFAULT_LIVE, TASK_PRIO_NORMAL, TASK_NEED_RSP_FLAG, TASK_NEED_ALL_RSP,
             parent,
             &ret, FI_cbgt_split_register, ERR_MODULE_ID, table_name     , local_table_id, &local_mod_node,
    ...
    if(EC_FALSE == ret)
    {
        ...
        cbytes_clean(&left_colf_row, LOC_CBGT_0176);
        cbytes_clean(&right_colf_row, LOC_CBGT_0177);
    ...
    cbytes_clean(table_name, LOC_CBGT_0178);
    cbytes_clone(&right_colf_row, table_name);

    cbytes_clean(&left_colf_row, LOC_CBGT_0179);
    cbytes_clean(&right_colf_row, LOC_CBGT_0180);
...
EC_BOOL cbgt_split(const UINT32 cbgt_md_id)
{
    ...
    CBGT_MD_CRWLOCK_TABLE_UNLOCK(cbgt_md, LOC_CBGT_0183);
    return (EC_TRUE);
}
...
EC_BOOL cbgt_merge_table(const UINT32 cbgt_md_id, const CBYTES *left_table_name, const UINT32 left_table_id)
{
    ...
    CBGT_MD_CRWLOCK_TABLE_WRLOCK(cbgt_md, LOC_CBGT_0186);
    ...
    task_p2p(cbgt_md_id, TASK_DEFAULT_LIVE, TASK_PRIO_NORMAL, TASK_NEED_RSP_FLAG, TASK_NEED_ALL_RSP,
             parent,
             &ret, FI_cbgt_merge_register, ERR_MODULE_ID, right_table_name , right_table_id, &right_mod_node,
    ...
    /*handover*/
    cbytes_free(CBGT_MD_TABLE_NAME(cbgt_md), LOC_CBGT_0193);
    CBGT_MD_TABLE_NAME(cbgt_md) = des_table_name;

    cbgt_unlink(cbgt_md_id, left_table_id);

    cbgt_gdb_flush(right_gdb);
    CBGT_MD_CRWLOCK_TABLE_UNLOCK(cbgt_md, LOC_CBGT_0194);
    return (EC_TRUE);
}
...
EC_BOOL cbgt_flush(const UINT32 cbgt_md_id)
{
    ...
    cbgt_md = CBGT_MD_GET(cbgt_md_id);
    CBGT_MD_WAS_ACCESS(cbgt_md, LOC_CBGT_0195);

    if(NULL_PTR != CBGT_MD_GDB(cbgt_md))
    {
        CBGT_MD_CMUTEX_TABLE_ID_POOL_LOCK(cbgt_md, LOC_CBGT_0196);
        cbgt_gdb_flush(CBGT_MD_GDB(cbgt_md));
        CBGT_MD_CMUTEX_TABLE_ID_POOL_UNLOCK(cbgt_md, LOC_CBGT_0197);
    }
    ...
    if(EC_TRUE == cbgt_is_root_server(cbgt_md_id))
    {
        ...
        CBGT_MD_CMUTEX_TABLE_ID_POOL_LOCK(cbgt_md, LOC_CBGT_0198);
        /*flush bitmap*/
        table_id_pool_fname = __cbgt_gen_cbitmap_file_name_cstr(CBGT_MD_ROOT_PATH(cbgt_md));
        __cbgt_flush_table_id_pool(cbgt_md_id, table_id_pool_fname, CBGT_MD_TABLE_ID_POOL(cbgt_md));
        cstring_free(table_id_pool_fname);
        ...
        CBGT_MD_CMUTEX_TABLE_ID_POOL_UNLOCK(cbgt_md, LOC_CBGT_0199);
    }
...
EC_BOOL cbgt_exist_table(const UINT32 cbgt_md_id, const CBYTES *table_name)
{
    ...
    cbgt_md = CBGT_MD_GET(cbgt_md_id);
    CBGT_MD_WAS_ACCESS(cbgt_md, LOC_CBGT_0200);
    ...
    CBGT_MD_CRWLOCK_TABLE_RDLOCK(cbgt_md, LOC_CBGT_0201);
    gdb = CBGT_MD_GDB(cbgt_md);

    if(NULL_PTR != cbgt_gdb_search_key(gdb, cbytes_buf(&key)))
    {
        CBGT_MD_CRWLOCK_TABLE_UNLOCK(cbgt_md, LOC_CBGT_0202);
        cbgt_key_clean(cbgt_md_id, &key);
        return (EC_TRUE);
    }
    CBGT_MD_CRWLOCK_TABLE_UNLOCK(cbgt_md, LOC_CBGT_0203);
...
EC_BOOL cbgt_create_table_on_root(const UINT32 cbgt_md_id, const CBYTES *table_name, const CVECTOR *col_family_name_vec)
{
    ...
    task_super_mono(CBGT_MD_MOD_MGR(cbgt_md), TASK_DEFAULT_LIVE, TASK_PRIO_NORMAL, TASK_NEED_RSP_FLAG, TASK_NEED_ALL_RSP,
                     &meta_mod_node,
                     &ret, FI_cbgt_create_table_on_meta, ERR_MODULE_ID, col_family_name_vec);
...
EC_BOOL cbgt_create_table_on_colf(const UINT32 cbgt_md_id, const CBYTES *colf_row)
{
    ...
    cbgt_md = CBGT_MD_GET(cbgt_md_id);
    CBGT_MD_WAS_ACCESS(cbgt_md, LOC_CBGT_0207);
...
static EC_BOOL __cbgt_get_table_and_key_no_lock(const UINT32 cbgt_md_id, const CBYTES *table_key, UINT32 *table_id, MOD_NODE *mod_node, CBYTES *key_bytes)
{
    ...
    cbgt_md = CBGT_MD_GET(cbgt_md_id);
    CBGT_MD_WAS_ACCESS(cbgt_md, LOC_CBGT_0208);
...
static EC_BOOL __cbgt_get_table(const UINT32 cbgt_md_id, const CBYTES *table_name, UINT32 *table_id, MOD_NODE *mod_node)
{
    ...
    cbgt_md = CBGT_MD_GET(cbgt_md_id);
    CBGT_MD_WAS_ACCESS(cbgt_md, LOC_CBGT_0209);
    ...
    CBGT_MD_CRWLOCK_TABLE_RDLOCK(cbgt_md, LOC_CBGT_0210);
    ...
    vlen  = kvGetvLenHs(kv);    
    CBGT_MD_CRWLOCK_TABLE_UNLOCK(cbgt_md, LOC_CBGT_0212);
...
EC_BOOL cbgt_get_colf_table_from_root(const UINT32 cbgt_md_id, const CBYTES *table_name, const CBYTES *colf, UINT32 *table_id, MOD_NODE *mod_node)
{
    ...
    task_p2p(cbgt_md_id, TASK_DEFAULT_LIVE, TASK_PRIO_NORMAL, TASK_NEED_RSP_FLAG, TASK_NEED_ALL_RSP,
             &meta_mod_node,
             &ret, FI_cbgt_get_colf_table_from_meta, ERR_MODULE_ID, colf, table_id, mod_node);
...
EC_BOOL cbgt_get_colf_table_from_meta(const UINT32 cbgt_md_id, const CBYTES *colf, UINT32 *table_id, MOD_NODE *mod_node)
{
    ...
    cbgt_md = CBGT_MD_GET(cbgt_md_id);
    parent  = CBGT_MD_PARENT_MOD(cbgt_md);
    CBGT_MD_WAS_ACCESS(cbgt_md, LOC_CBGT_0222);
...
EC_BOOL cbgt_get_user_table_from_root(const UINT32 cbgt_md_id, const CBYTES *table_name, const CBYTES *row, const CBYTES *colf, const CBYTES *colq, UINT32 *table_id, MOD_NODE *mod_node)
{
    ...
    cbgt_md = CBGT_MD_GET(cbgt_md_id);
    parent  = CBGT_MD_PARENT_MOD(cbgt_md);
    CBGT_MD_WAS_ACCESS(cbgt_md, LOC_CBGT_0223);
#if 0
    if(EC_FALSE == cbgt_is_root_server(cbgt_md_id))
    {
    ...
    task_p2p(cbgt_md_id, TASK_DEFAULT_LIVE, TASK_PRIO_NORMAL, TASK_NEED_RSP_FLAG, TASK_NEED_ALL_RSP,
             &meta_mod_node,
             &ret, FI_cbgt_get_user_table_from_meta, ERR_MODULE_ID, row, colf, colq, table_id, mod_node);
...
EC_BOOL cbgt_get_user_table_from_meta(const UINT32 cbgt_md_id, const CBYTES *row, const CBYTES *colf, const CBYTES *colq, UINT32 *table_id, MOD_NODE *mod_node)
{
    ...
    cbgt_md = CBGT_MD_GET(cbgt_md_id);
    parent  = CBGT_MD_PARENT_MOD(cbgt_md);
    CBGT_MD_WAS_ACCESS(cbgt_md, LOC_CBGT_0224);
    ...
    task_p2p(cbgt_md_id, TASK_DEFAULT_LIVE, TASK_PRIO_NORMAL, TASK_NEED_RSP_FLAG, TASK_NEED_ALL_RSP,
             &colf_mod_node,
             &ret, FI_cbgt_get_user_table_from_colf, ERR_MODULE_ID, row, colf, colq, table_id, mod_node);
...
static EC_BOOL __cbgt_open_rmc_table(const UINT32 cbgt_md_id, const UINT32 server_type, const CBYTES *table_name, UINT32 *table_id, MOD_NODE *mod_node)
{
    ...
    cbgt_md = CBGT_MD_GET(cbgt_md_id);
    CBGT_MD_WAS_ACCESS(cbgt_md, LOC_CBGT_0226);
    ...
    CBGT_MD_CRWLOCK_TABLE_WRLOCK(cbgt_md, LOC_CBGT_0227);
    ...
    if(EC_FALSE == CBGT_CHECK_TABLE_EXIST(cbgt_md_id, son_table_id, &son_mod_node))
    {
        ...
        if(EC_FALSE == cbgt_update_register_no_lock(cbgt_md_id, &key_bytes, son_table_id, &son_mod_node))
        {
            ...
            sys_log(LOGSTDOUT, "error:__cbgt_open_rmc_table: update register of table %.*s id %ld type %s (tcid %s, comm %ld, rank %ld, modi %ld) "
                               ...
                               MOD_NODE_TCID_STR(&son_mod_node), MOD_NODE_COMM(&son_mod_node), MOD_NODE_RANK(&son_mod_node), MOD_NODE_MODI(&son_mod_node),
                               CBGT_MD_TABLE_ID(cbgt_md), __cbgt_type(CBGT_MD_TYPE(cbgt_md)));
            cbytes_clean(&key_bytes, LOC_CBGT_0234);
            cstring_clean(&meta_session_path);
            cstring_clean(&colf_session_path);            
            return (EC_FALSE);
        }
    ...
    CBGT_MD_CRWLOCK_TABLE_UNLOCK(cbgt_md, LOC_CBGT_0235);
    cbytes_clean(&key_bytes, LOC_CBGT_0236);
...
static EC_BOOL __cbgt_open_user_table(const UINT32 cbgt_md_id, const CBYTES *user_table_key, CBYTES *user_table_name, UINT32 *table_id, MOD_NODE *mod_node)
{
...
#endif
    cbgt_md = CBGT_MD_GET(cbgt_md_id);
    CBGT_MD_WAS_ACCESS(cbgt_md, LOC_CBGT_0237);
    ...
    CBGT_MD_CRWLOCK_TABLE_WRLOCK(cbgt_md, LOC_CBGT_0238);
    ...
    if(EC_FALSE == CBGT_CHECK_TABLE_EXIST(cbgt_md_id, user_table_id, &user_mod_node))
    {
        ...
        if(EC_FALSE == cbgt_update_register_no_lock(cbgt_md_id, &key_bytes, user_table_id, &user_mod_node))
        {
            ...
            sys_log(LOGSTDOUT, "error:__cbgt_open_user_table: register user table %ld (tcid %s, comm %ld, rank %ld, modi %ld) "
                               ...
                               MOD_NODE_TCID_STR(&user_mod_node), MOD_NODE_COMM(&user_mod_node), MOD_NODE_RANK(&user_mod_node), MOD_NODE_MODI(&user_mod_node),
                               CBGT_MD_TABLE_ID(cbgt_md));
            cbytes_clean(&key_bytes, LOC_CBGT_0247);
            return (EC_FALSE);
        }
    }
    CBGT_MD_CRWLOCK_TABLE_UNLOCK(cbgt_md, LOC_CBGT_0248);
    cbytes_clean(&key_bytes, LOC_CBGT_0249);
...
EC_BOOL cbgt_open_colf_table_from_root(const UINT32 cbgt_md_id, const CBYTES *table_name, const CBYTES *colf, UINT32 *table_id, MOD_NODE *mod_node)
{
    ...
    task_p2p(cbgt_md_id, TASK_DEFAULT_LIVE, TASK_PRIO_NORMAL, TASK_NEED_RSP_FLAG, TASK_NEED_ALL_RSP,
             &meta_mod_node,
             &ret, FI_cbgt_open_colf_table_from_meta, ERR_MODULE_ID, colf, table_id, mod_node);
...
EC_BOOL cbgt_open_user_table_from_root(const UINT32 cbgt_md_id, const CBYTES *table_name, const CBYTES * row, const CBYTES *colf, const CBYTES * colq, CBYTES *user_table_name, UINT32 *table_id, MOD_NODE *mod_node)
{
    ...
    task_p2p(cbgt_md_id, TASK_DEFAULT_LIVE, TASK_PRIO_NORMAL, TASK_NEED_RSP_FLAG, TASK_NEED_ALL_RSP,
             &meta_mod_node,
             &ret, FI_cbgt_open_user_table_from_meta, ERR_MODULE_ID, row, colf, colq, user_table_name, table_id, mod_node);
...
EC_BOOL cbgt_open_user_table_from_meta(const UINT32 cbgt_md_id, const CBYTES * row, const CBYTES *colf, const CBYTES * colq, CBYTES *user_table_name, UINT32 *table_id, MOD_NODE *mod_node)
{
    ...
    task_p2p(cbgt_md_id, TASK_DEFAULT_LIVE, TASK_PRIO_NORMAL, TASK_NEED_RSP_FLAG, TASK_NEED_ALL_RSP,
             &colf_mod_node,
             &ret, FI_cbgt_open_user_table_from_colf, ERR_MODULE_ID, row, colf, colq, user_table_name, table_id, mod_node);
...
EC_BOOL cbgt_close_rmc_table(const UINT32 cbgt_md_id, const CBYTES *table_name, const UINT32 table_id)
{
    ...
    cbgt_md = CBGT_MD_GET(cbgt_md_id);
    CBGT_MD_WAS_ACCESS(cbgt_md, LOC_CBGT_0255);
    ...
    CBGT_MD_CRWLOCK_TABLE_WRLOCK(cbgt_md, LOC_CBGT_0256);
    ...
    cbytes_clean(&key_bytes, LOC_CBGT_0261);
    ...
    CBGT_MD_CRWLOCK_TABLE_UNLOCK(cbgt_md, LOC_CBGT_0262);
    return (EC_TRUE);
}
...
EC_BOOL cbgt_close_user_table(const UINT32 cbgt_md_id, const CBYTES *table_name, const UINT32 table_id)
{
    ...
    cbgt_md = CBGT_MD_GET(cbgt_md_id);
    CBGT_MD_WAS_ACCESS(cbgt_md, LOC_CBGT_0263);
    ...
    CBGT_MD_CRWLOCK_TABLE_WRLOCK(cbgt_md, LOC_CBGT_0264);
    ...
    cbytes_clean(&colf_table_key, LOC_CBGT_0267);
    ...
    if(table_id != _table_id)
    {
        ...
        __cbgt_print_colf_table_key(LOGSTDOUT, cbytes_buf(table_name));
        sys_print(LOGSTDOUT, "\n");
        cbytes_clean(&key_bytes, LOC_CBGT_0269);
        return (EC_FALSE);
    }
    ...
    cbytes_clean(&key_bytes, LOC_CBGT_0272);
    ...
    mod_mgr_excl(MOD_NODE_TCID(&table_mod_node),
                 ...
                 MOD_NODE_MODI(&table_mod_node),
                 CBGT_MD_MOD_MGR(cbgt_md));
    CBGT_MD_CRWLOCK_TABLE_UNLOCK(cbgt_md, LOC_CBGT_0273);
...
EC_BOOL cbgt_report_closing(const UINT32 cbgt_md_id)
{
    ...
    table_id   = CBGT_MD_TABLE_ID(cbgt_md);
    table_name = CBGT_MD_TABLE_NAME(cbgt_md);
    CBGT_MD_WAS_ACCESS(cbgt_md, LOC_CBGT_0274);
    ...
    if(EC_TRUE == cbgt_is_root_server(cbgt_md_id))
    {
        ...
        CBGT_MD_CRWLOCK_TABLE_WRLOCK(cbgt_md, LOC_CBGT_0275);
        __cbgt_flush_root_record_file(cbgt_md_id, root_path, table_id, &error_mod_node);
        CBGT_MD_CRWLOCK_TABLE_UNLOCK(cbgt_md, LOC_CBGT_0276);
#endif        
        return (EC_TRUE);
    }
    ...
    if(EC_TRUE == cbgt_is_meta_server(cbgt_md_id))
    {
        ...
        task_p2p(cbgt_md_id, TASK_DEFAULT_LIVE, TASK_PRIO_NORMAL, TASK_NEED_RSP_FLAG, TASK_NEED_ALL_RSP,
                parent,
                &ret, FI_cbgt_close_rmc_table, ERR_MODULE_ID, table_name, table_id);
    ...
    if(EC_TRUE == cbgt_is_user_server(cbgt_md_id))
    {
        ...
        task_p2p(cbgt_md_id, TASK_DEFAULT_LIVE, TASK_PRIO_NORMAL, TASK_NEED_RSP_FLAG, TASK_NEED_ALL_RSP,
                parent,
                &ret, FI_cbgt_close_user_table, ERR_MODULE_ID, table_name, table_id);
...
EC_BOOL cbgt_fetch_key_no_lock(const UINT32 cbgt_md_id, const CBYTES *kv_bytes, CBYTES *key_bytes)
{
    ...
    cbgt_md  = CBGT_MD_GET(cbgt_md_id);
    CBGT_MD_WAS_ACCESS(cbgt_md, LOC_CBGT_0277);
...
EC_BOOL cbgt_fetch_key(const UINT32 cbgt_md_id, const CBYTES *kv_bytes, CBYTES *key_bytes)
{
    ...
    //CBGT_MD_CRWLOCK_TABLE_RDLOCK(cbgt_md, LOC_CBGT_0278);
    ...
    //CBGT_MD_CRWLOCK_TABLE_UNLOCK(cbgt_md, LOC_CBGT_0280);
...
EC_BOOL cbgt_fetch_row(const UINT32 cbgt_md_id, const CBYTES *kv_bytes, CBYTES *row_bytes)
{
    ...
    //CBGT_MD_CRWLOCK_TABLE_RDLOCK(cbgt_md, LOC_CBGT_0282);
...
EC_BOOL cbgt_fetch_from_rmc_no_lock(const UINT32 cbgt_md_id, const CBYTES *kv_bytes, UINT32 *table_id, MOD_NODE *mod_node)
{
    ...
    cbgt_md  = CBGT_MD_GET(cbgt_md_id);
    CBGT_MD_WAS_ACCESS(cbgt_md, LOC_CBGT_0285);
...
EC_BOOL cbgt_insert_rfqv(const UINT32 cbgt_md_id, const CBYTES *row, const CBYTES *colf, const CBYTES *colq, const CBYTES *val)
{
    ...
    if(EC_TRUE == cbgt_is_user_server(cbgt_md_id))/*working on user table*/
    {
        ...
        CBGT_MD_CRWLOCK_TABLE_WRLOCK(cbgt_md, LOC_CBGT_0292);
        ...
        if(EC_FALSE == __cbgt_cmp_colf_row_and_user_table_key(cbytes_buf(CBGT_MD_TABLE_NAME(cbgt_md)), cbytes_buf(&user_rowkey)))
        {
            ...
            sys_print(LOGSTDOUT, "\n");
            cbytes_clean(&user_rowkey, LOC_CBGT_0294);
            return (EC_OBSCURE);/*ask caller to try again*/
        }
        cbytes_clean(&user_rowkey, LOC_CBGT_0295);

        if(EC_FALSE == cbgt_insert_rfqv_no_lock(cbgt_md_id, row, colf, colq, val))
        {
            CBGT_MD_CRWLOCK_TABLE_UNLOCK(cbgt_md, LOC_CBGT_0296);
            return (EC_FALSE);
        }
        CBGT_MD_CRWLOCK_TABLE_UNLOCK(cbgt_md, LOC_CBGT_0297);

        return (EC_TRUE);
    }

    /*working on non-user table*/
    CBGT_MD_CRWLOCK_TABLE_WRLOCK(cbgt_md, LOC_CBGT_0298);
    if(EC_FALSE == cbgt_insert_rfqv_no_lock(cbgt_md_id, row, colf, colq, val))
    {
        CBGT_MD_CRWLOCK_TABLE_UNLOCK(cbgt_md, LOC_CBGT_0299);
        return (EC_FALSE);
    }
...
EC_BOOL cbgt_update_value_no_lock(const UINT32 cbgt_md_id, const CBYTES *key, CBYTES *val)
{
    ...
    cbgt_md = CBGT_MD_GET(cbgt_md_id);
    CBGT_MD_WAS_ACCESS(cbgt_md, LOC_CBGT_0301);
...
EC_BOOL cbgt_update_value(const UINT32 cbgt_md_id, const CBYTES *key, CBYTES *val)
{
    ...
    CBGT_MD_CRWLOCK_TABLE_WRLOCK(cbgt_md, LOC_CBGT_0302);
    ...
    CBGT_MD_CRWLOCK_TABLE_UNLOCK(cbgt_md, LOC_CBGT_0304);
    return (EC_TRUE);
}
...
EC_BOOL cbgt_fetch_user_table_no_lock(const UINT32 cbgt_md_id, const CBYTES *row, const CBYTES *colf, const CBYTES *colq, UINT32 *user_table_id, MOD_NODE *user_mod_node)
{
    ...
    cbgt_md = CBGT_MD_GET(cbgt_md_id);
    CBGT_MD_WAS_ACCESS(cbgt_md, LOC_CBGT_0311);
    ...
    if(EC_FALSE == CBGT_CHECK_TABLE_EXIST(cbgt_md_id, (*user_table_id), user_mod_node))
    {
        ...
        cbytes_clean(&col_row, LOC_CBGT_0316);
...
EC_BOOL cbgt_fetch_user_table(const UINT32 cbgt_md_id, const CBYTES *row, const CBYTES *colf, const CBYTES *colq, UINT32 *user_table_id, MOD_NODE *user_mod_node)
{
    ...
    cbgt_md = CBGT_MD_GET(cbgt_md_id);
    CBGT_MD_WAS_ACCESS(cbgt_md, LOC_CBGT_0319);

    CBGT_MD_CRWLOCK_TABLE_WRLOCK(cbgt_md, LOC_CBGT_0320);
...
EC_BOOL cbgt_insert_colf(const UINT32 cbgt_md_id, const CBYTES *row, const CBYTES *colf, const CBYTES *colq, const CBYTES *val)
{
    ...
    cbgt_md = CBGT_MD_GET(cbgt_md_id);
    CBGT_MD_WAS_ACCESS(cbgt_md, LOC_CBGT_0323);
    ...
    **/
    ...
    do
    {
        ...
        task_p2p(cbgt_md_id, TASK_DEFAULT_LIVE, TASK_PRIO_NORMAL, TASK_NEED_RSP_FLAG, TASK_NEED_ALL_RSP,
                 &user_mod_node,
                 &ret, FI_cbgt_insert_rfqv, ERR_MODULE_ID, row, colf, colq, val);
...
static EC_BOOL __cbgt_set_user_table_to_session(const UINT32 cbgt_md_id, const CSTRING *colf_session_path, const CBYTES *user_table_name, const UINT32 user_table_id, const MOD_NODE *mod_node)
{
    ...
    cstring_clean(&path);
    safe_free(user_table_name_hex_str, LOC_CBGT_0325);
    return (EC_TRUE);
}
...
static EC_BOOL __cbgt_check_user_csession_item_is_expected_user_table(const CSESSION_ITEM *user_csession_item, const CBYTES *user_table_key_bytes)
{
    ...
    {
        safe_free(colf_row_bytes, LOC_CBGT_0326);
        return (EC_FALSE);
    }

    safe_free(colf_row_bytes, LOC_CBGT_0327);    
#endif    
    return (EC_TRUE);
}
                                                                ...
                                                                UINT32 *user_table_id, MOD_NODE *mod_node)
{
    ...
    cbytes_clean(&user_table_key_bytes, LOC_CBGT_0329);
...
void cbgt_was_access(const UINT32 cbgt_md_id)
{
    ...
    cbgt_md = CBGT_MD_GET(cbgt_md_id);
    CBGT_MD_WAS_ACCESS(cbgt_md, LOC_CBGT_0331);
#if 0
    if(NULL_PTR != CBGT_MD_PARENT_MOD(cbgt_md))
    {
        task_p2p_no_wait(cbgt_md_id, TASK_DEFAULT_LIVE, TASK_PRIO_NORMAL, TASK_NOT_NEED_RSP_FLAG, TASK_NEED_NONE_RSP, 
                         CBGT_MD_PARENT_MOD(cbgt_md), NULL_PTR, FI_cbgt_was_access, ERR_MODULE_ID);    
    }
#endif
    return;
}
...
EC_BOOL cbgt_insert(const UINT32 cbgt_md_id, const CBYTES *table_name, const CBYTES *row, const CBYTES *colf, const CBYTES *colq, const CBYTES *val)
{
    ...
    cbgt_md = CBGT_MD_GET(cbgt_md_id);
    root_mod_node = CBGT_MD_ROOT_MOD(cbgt_md);
    CBGT_MD_WAS_ACCESS(cbgt_md, LOC_CBGT_0333);
...
EC_BOOL cbgt_fetch_kv_from_colf_no_lock(const UINT32 cbgt_md_id, const CBYTES *row, const CBYTES *colf, const CBYTES *colq, CBYTES *kv)
{
    ...
    cbgt_md = CBGT_MD_GET(cbgt_md_id);
    CBGT_MD_WAS_ACCESS(cbgt_md, LOC_CBGT_0334);
...
EC_BOOL cbgt_search_from_colf(const UINT32 cbgt_md_id, const CBYTES *row, const CBYTES *colf, const CBYTES *colq, CBYTES *val)
{
    ...
    cbgt_md = CBGT_MD_GET(cbgt_md_id);
    CBGT_MD_WAS_ACCESS(cbgt_md, LOC_CBGT_0335);
    ...
    CBGT_MD_CRWLOCK_TABLE_RDLOCK(cbgt_md, LOC_CBGT_0336);
    colf_gdb = CBGT_MD_GDB(cbgt_md);
...
EC_BOOL cbgt_search_from_user(const UINT32 cbgt_md_id, const CBYTES *row, const CBYTES *colf, const CBYTES *colq, CBYTES *val)
{
    ...
    cbgt_md = CBGT_MD_GET(cbgt_md_id);
    CBGT_MD_WAS_ACCESS(cbgt_md, LOC_CBGT_0339);
    ...
    CBGT_MD_CRWLOCK_TABLE_RDLOCK(cbgt_md, LOC_CBGT_0340);
...
EC_BOOL cbgt_search(const UINT32 cbgt_md_id, const CBYTES *table_name, const CBYTES *row, const CBYTES *colf, const CBYTES *colq, CBYTES *val)
{
    ...
    if(EC_FALSE == cbgt_open_user_table_from_root(cbgt_md_id, table_name, row, colf, colq, &user_table_name, &user_table_id, &user_mod_node))
    {
        sys_log(LOGSTDOUT, "error:cbgt_search: open user table of %.*s (%.*s:%.*s:%.*s) failed\n",
                            ...
                            cbytes_len(colf), (char *)cbytes_buf(colf),
                            cbytes_len(colq), (char *)cbytes_buf(colq));
        cbytes_clean(&user_table_name, LOC_CBGT_0344);
        return (EC_FALSE);
    }
    cbytes_clean(&user_table_name, LOC_CBGT_0345);

    /*search in user table*/
    ret = EC_FALSE;
    task_p2p(cbgt_md_id, TASK_DEFAULT_LIVE, TASK_PRIO_NORMAL, TASK_NEED_RSP_FLAG, TASK_NEED_ALL_RSP,
             &user_mod_node,
             &ret,FI_cbgt_search_from_user, ERR_MODULE_ID, row, colf, colq, val);
...
EC_BOOL cbgt_fetch_from_user(const UINT32 cbgt_md_id, const CBYTES *row, const CBYTES *colf, const CBYTES *colq, CBYTES *val)
{
    ...
    cbgt_md = CBGT_MD_GET(cbgt_md_id);
    CBGT_MD_WAS_ACCESS(cbgt_md, LOC_CBGT_0346);
    ...
    sys_print(LOGSTDOUT, "\n");
#endif
    CBGT_MD_CRWLOCK_TABLE_RDLOCK(cbgt_md, LOC_CBGT_0347);
    ...
    if(EC_FALSE == __cbgt_cmp_colf_row_and_user_table_key(cbytes_buf(CBGT_MD_TABLE_NAME(cbgt_md)), cbytes_buf(&user_rowkey)))
    {
        ...
        __cbgt_print_colf_table_row(LOGSTDOUT, cbytes_buf(CBGT_MD_TABLE_NAME(cbgt_md)));
        sys_print(LOGSTDOUT, "\n");
        cbytes_clean(&user_rowkey, LOC_CBGT_0349);
        return (EC_OBSCURE);/*ask caller to try again*/
    }
#if 0
    ...
    do
    {
        ...
        if(EC_FALSE == cbgt_open_user_table_from_root(cbgt_md_id, table_name, row, colf, colq, &user_table_name, &user_table_id, &user_mod_node))
        {
            sys_log(LOGSTDOUT, "error:cbgt_fetch: open user table of %.*s (%.*s:%.*s:%.*s) failed\n",
                                ...
                                cbytes_len(colf), (char *)cbytes_buf(colf),
                                cbytes_len(colq), (char *)cbytes_buf(colq));
            cbytes_clean(&user_table_name, LOC_CBGT_0353);
            return (EC_FALSE);
        }
        ...
        task_p2p(cbgt_md_id, TASK_DEFAULT_LIVE, TASK_PRIO_NORMAL, TASK_NEED_RSP_FLAG, TASK_NEED_ALL_RSP,
                 &user_mod_node,
                 &ret,FI_cbgt_fetch_from_user, ERR_MODULE_ID, row, colf, colq, val);
...
EC_BOOL __cbgt_fetch(const UINT32 cbgt_md_id, const CBYTES *table_name, const CBYTES *row, const CBYTES *colf, const CBYTES *colq, CBYTES *val)
{
    ...
    if(EC_FALSE == __cbgt_get_colf_table_from_session(cbgt_md_id, table_name, colf, &colf_session_path, &colf_table_id, &colf_mod_node))
    {
        ...
        task_p2p(cbgt_md_id, TASK_DEFAULT_LIVE, TASK_PRIO_NORMAL, TASK_NEED_RSP_FLAG, TASK_NEED_ALL_RSP,
                 &colf_mod_node,
                 &ret,FI_cbgt_open_user_table_from_colf, ERR_MODULE_ID, row, colf, colq, &user_table_name, &user_table_id, &user_mod_node);    
        ...
        if(EC_FALSE == __cbgt_get_user_table_from_session(cbgt_md_id, &colf_session_path, row, colf, colq, &user_table_id, &user_mod_node))
        {
            ...
            if(EC_FALSE == ret)
            {
                sys_log(LOGSTDOUT, "error:__cbgt_fetch: open user table of %.*s (%.*s:%.*s:%.*s) from colf table %ld:(tcid %s, comm %ld, rank %ld, modi %ld) failed\n",
                                    ...
                                    MOD_NODE_MODI(&colf_mod_node));
                cstring_clean(&colf_session_path);
                cbytes_clean(&user_table_name, LOC_CBGT_0358);
                return (EC_FALSE);
            }

            __cbgt_set_user_table_to_session(cbgt_md_id, &colf_session_path, &user_table_name, user_table_id, &user_mod_node);
            cbytes_clean(&user_table_name, LOC_CBGT_0359);        
        }
#if 0     
        else
        {
...
EC_BOOL cbgt_delete_from_user(const UINT32 cbgt_md_id, const CBYTES *row, const CBYTES *colf, const CBYTES *colq)
{
    ...
    CBGT_MD_CRWLOCK_TABLE_WRLOCK(cbgt_md, LOC_CBGT_0361);
    ...
    if(EC_FALSE == __cbgt_cmp_colf_row_and_user_table_key(cbytes_buf(CBGT_MD_TABLE_NAME(cbgt_md)), cbytes_buf(&user_rowkey)))
    {
        ...
        __cbgt_print_colf_table_row(LOGSTDOUT, cbytes_buf(CBGT_MD_TABLE_NAME(cbgt_md)));
        sys_print(LOGSTDOUT, "\n");
        cbytes_clean(&user_rowkey, LOC_CBGT_0363);
        return (EC_OBSCURE);/*ask caller to try again*/
    }
    ...
    if(EC_FALSE == cbgt_delete_kv_no_lock(cbgt_md_id, &user_rowkey))
    {
        ...
        sys_log(LOGSTDOUT, "error:cbgt_delete_from_user: delete key of (%.*s:%.*s:%.*s) on table %ld failed\n",
                            ...
                            cbytes_len(colq), (char *)cbytes_buf(colq),
                            CBGT_MD_TABLE_ID(cbgt_md));
        cbytes_clean(&user_rowkey, LOC_CBGT_0365);
        return (EC_FALSE);
    }
    CBGT_MD_CRWLOCK_TABLE_UNLOCK(cbgt_md, LOC_CBGT_0366);

    cbytes_clean(&user_rowkey, LOC_CBGT_0367);
    return (EC_TRUE);
}
...
EC_BOOL cbgt_delete_from_colf(const UINT32 cbgt_md_id, const CBYTES *row, const CBYTES *colf, const CBYTES *colq)
{
    ...
    if(EC_FALSE == cbgt_open_user_table_from_colf(cbgt_md_id, row, colf, colq, &user_table_name, &user_table_id, &user_mod_node))
    {
        sys_log(LOGSTDOUT, "error:cbgt_delete_from_colf: open user table for (%.*s:%.*s:%.*s) in colf table %ld failed\n",
                            ...
                            cbytes_len(colq), (char *)cbytes_buf(colq),
                            CBGT_MD_TABLE_ID(cbgt_md));
        cbytes_clean(&user_table_name, LOC_CBGT_0369);
        return (EC_FALSE);
    }
    cbytes_clean(&user_table_name, LOC_CBGT_0370);
    ...
    task_p2p(cbgt_md_id, TASK_DEFAULT_LIVE, TASK_PRIO_NORMAL, TASK_NEED_RSP_FLAG, TASK_NEED_ALL_RSP,
             &user_mod_node,
             &ret,FI_cbgt_delete_from_user, ERR_MODULE_ID, row, colf, colq);
...
EC_BOOL cbgt_delete(const UINT32 cbgt_md_id, const CBYTES *table_name, const CBYTES *row, const CBYTES *colf, const CBYTES *colq)
{
    ...
    cbgt_md = CBGT_MD_GET(cbgt_md_id);
    CBGT_MD_WAS_ACCESS(cbgt_md, LOC_CBGT_0371);
    ...
    do
    {
        ...
        if(EC_FALSE == cbgt_open_user_table_from_root(cbgt_md_id, table_name, row, colf, colq, &user_table_name, &user_table_id, &user_mod_node))
        {
            sys_log(LOGSTDOUT, "error:cbgt_delete: open user table of table %.*s (%.*s:%.*s:%.*s) failed\n",
                                ...
                                cbytes_len(colf), (char *)cbytes_buf(colf),
                                cbytes_len(colq), (char *)cbytes_buf(colq));
            cbytes_clean(&user_table_name, LOC_CBGT_0372);
            return (EC_FALSE);
        }
        cbytes_clean(&user_table_name, LOC_CBGT_0373);
...
EC_BOOL cbgt_cleanup_colf_table(const UINT32 cbgt_md_id, const CBYTES *table_name)
{
    ...
    cbgt_md = CBGT_MD_GET(cbgt_md_id);
    gdb = CBGT_MD_GDB(cbgt_md);
    CBGT_MD_WAS_ACCESS(cbgt_md, LOC_CBGT_0374);
...
static EC_BOOL __cbgt_cleanup_meta_table_one_kv(const UINT32 cbgt_md_id, const UINT8 *kv)
{
    ...
    if(EC_FALSE == __cbgt_open_rmc_table(cbgt_md_id, CBGT_TYPE_COLF_SERVER, &colf_table_name, &colf_table_id, &colf_mod_node))
    {
        ...
        sys_print(LOGSTDOUT, "\n");
        cbytes_clean(&colf_table_name, LOC_CBGT_0375);
        return (EC_FALSE);
    }
    ...
    if(EC_FALSE == ret)
    {
        ...
        __cbgt_print_meta_table_key(LOGSTDOUT, kv);
        sys_print(LOGSTDOUT, "\n");
        cbytes_clean(&colf_table_name, LOC_CBGT_0376);
        return (EC_FALSE);
    }
...
EC_BOOL cbgt_cleanup_meta_table(const UINT32 cbgt_md_id, const CBYTES *table_name)
{
    ...
    cbgt_md = CBGT_MD_GET(cbgt_md_id);
    gdb = CBGT_MD_GDB(cbgt_md);
    CBGT_MD_WAS_ACCESS(cbgt_md, LOC_CBGT_0377);
...
EC_BOOL cbgt_delete_user_table(const UINT32 cbgt_md_id, const CBYTES *table_name)
{
    ...
    cbgt_md = CBGT_MD_GET(cbgt_md_id);
    CBGT_MD_WAS_ACCESS(cbgt_md, LOC_CBGT_0378);
    ...
    cbytes_clean(&root_rowkey, LOC_CBGT_0380);
...
EC_BOOL cbgt_delete_colf_table(const UINT32 cbgt_md_id, const CBYTES *table_name, const CBYTES *colf_name)
{
    ...
    cbgt_md = CBGT_MD_GET(cbgt_md_id);
    CBGT_MD_WAS_ACCESS(cbgt_md, LOC_CBGT_0381);
    ...
    if(EC_TRUE == cbgt_is_meta_server(cbgt_md_id))
    {
        ...
        cbytes_clean(&meta_rowkey, LOC_CBGT_0383);
...
EC_BOOL cbgt_add_colf_table(const UINT32 cbgt_md_id, const CBYTES *table_name, const CBYTES *colf_name)
{
    ...
    cbgt_md = CBGT_MD_GET(cbgt_md_id);
    CBGT_MD_WAS_ACCESS(cbgt_md, LOC_CBGT_0384);
...
EC_BOOL cbgt_select_from_user(const UINT32 cbgt_md_id, const CSTRING *row_pattern, const CSTRING *colf_pattern, const CSTRING *colq_pattern, const CSTRING *val_pattern, CVECTOR *ret_kv_vec)
{
    ...
    cbgt_md     = CBGT_MD_GET(cbgt_md_id);
    CBGT_MD_WAS_ACCESS(cbgt_md, LOC_CBGT_0385);
    ...
    CBGT_MD_CRWLOCK_TABLE_RDLOCK(cbgt_md, LOC_CBGT_0386);
    gdb = CBGT_MD_GDB(cbgt_md);
...
EC_BOOL cbgt_select_from_colf(const UINT32 cbgt_md_id, const UINT32 cached_mode, const CSTRING *row_pattern, const CSTRING *colf_pattern, const CSTRING *colq_pattern, const CSTRING *val_pattern, CVECTOR *ret_kv_vec)
{
    ...
    cbgt_md     = CBGT_MD_GET(cbgt_md_id);
    CBGT_MD_WAS_ACCESS(cbgt_md, LOC_CBGT_0389);
    ...
    CBGT_MD_CRWLOCK_TABLE_RDLOCK(cbgt_md, LOC_CBGT_0391);
    gdb = CBGT_MD_GDB(cbgt_md);
    ret = EC_FALSE;
    ...
    CBGT_MD_CRWLOCK_TABLE_UNLOCK(cbgt_md, LOC_CBGT_0392);
    ...
    for(pos = 0; pos < cvector_size(colf_kv_vec); pos ++)
    {
        ...
        if(EC_TRUE == __cbgt_mod_node_is_valid(cbgt_md_id, &user_mod_node))
        {
            ...
            task_p2p_inc(task_mgr, cbgt_md_id, &user_mod_node,
                         &ret, FI_cbgt_select_from_user, ERR_MODULE_ID, 
    ...
    cvector_clean_with_location(colf_kv_vec, (CVECTOR_DATA_LOCATION_CLEANER)cbytes_free, LOC_CBGT_0398);
    cvector_free(colf_kv_vec, LOC_CBGT_0399);
    ...
    for(pos = 0; pos < cvector_size(report_vec); pos ++)
    {
        ...
        cvector_clean_with_location_no_lock(user_table_kv_vec, (CVECTOR_DATA_LOCATION_CLEANER)cbytes_free, LOC_CBGT_0400);
        cvector_free_no_lock(user_table_kv_vec, LOC_CBGT_0401);
        cvector_set_no_lock(report_vec, pos, NULL_PTR);
    }

    cvector_free_no_lock(report_vec, LOC_CBGT_0402);
...
EC_BOOL cbgt_select_from_meta(const UINT32 cbgt_md_id, const UINT32 cached_mode, const CSTRING *row_pattern, const CSTRING *colf_pattern, const CSTRING *colq_pattern, const CSTRING *val_pattern, CVECTOR *ret_kv_vec)
{
    ...
    cbgt_md     = CBGT_MD_GET(cbgt_md_id);
    CBGT_MD_WAS_ACCESS(cbgt_md, LOC_CBGT_0403);
    ...
    CBGT_MD_CRWLOCK_TABLE_RDLOCK(cbgt_md, LOC_CBGT_0405);
    gdb = CBGT_MD_GDB(cbgt_md);
    ...
    CBGT_MD_CRWLOCK_TABLE_UNLOCK(cbgt_md, LOC_CBGT_0406);
    ...
    for(pos = 0; pos < cvector_size(meta_kv_vec); pos ++)
    {
        ...
        if(EC_TRUE == __cbgt_mod_node_is_valid(cbgt_md_id, &colf_mod_node))
        {
            ...
            task_p2p_inc(task_mgr, cbgt_md_id, &colf_mod_node,
                         &ret, FI_cbgt_select_from_colf, ERR_MODULE_ID, cached_mode, 
                         row_pattern, colf_pattern, colq_pattern, val_pattern, 
                         user_table_kv_vec);
    ...
    cvector_clean_with_location(meta_kv_vec, (CVECTOR_DATA_LOCATION_CLEANER)cbytes_free, LOC_CBGT_0413);
    cvector_free(meta_kv_vec, LOC_CBGT_0414);
    ...
    for(pos = 0; pos < cvector_size(report_vec); pos ++)
    {
        ...
        cvector_clean_with_location_no_lock(user_table_kv_vec, (CVECTOR_DATA_LOCATION_CLEANER)cbytes_free, LOC_CBGT_0415);
        cvector_free_no_lock(user_table_kv_vec, LOC_CBGT_0416);
        cvector_set_no_lock(report_vec, pos, NULL_PTR);
    }

    cvector_free_no_lock(report_vec, LOC_CBGT_0417);
...
EC_BOOL cbgt_select_from_root(const UINT32 cbgt_md_id, const UINT32 cached_mode, const CSTRING *table_pattern, const CSTRING *row_pattern, const CSTRING *colf_pattern, const CSTRING *colq_pattern, const CSTRING *val_pattern, CVECTOR *ret_kv_vec)
{
    ...
    CBGT_MD_CRWLOCK_TABLE_RDLOCK(cbgt_md, LOC_CBGT_0420);
    gdb = CBGT_MD_GDB(cbgt_md);
    ...
    CBGT_MD_CRWLOCK_TABLE_UNLOCK(cbgt_md, LOC_CBGT_0421);
    ...
    for(pos = 0; pos < cvector_size(root_kv_vec); pos ++)
    {
        ...
        if(EC_TRUE == __cbgt_mod_node_is_valid(cbgt_md_id, &meta_mod_node))
        {
            ...
            task_p2p_inc(task_mgr, cbgt_md_id, &meta_mod_node,
                         &ret, FI_cbgt_select_from_meta, ERR_MODULE_ID, cached_mode, 
                         row_pattern, colf_pattern, colq_pattern, val_pattern, 
                         user_table_kv_vec);
    ...
    cvector_clean_with_location(root_kv_vec, (CVECTOR_DATA_LOCATION_CLEANER)cbytes_free, LOC_CBGT_0427);
    cvector_free(root_kv_vec, LOC_CBGT_0428);
    ...
    for(pos = 0; pos < cvector_size(report_vec); pos ++)
    {
        ...
        cvector_clean_with_location_no_lock(user_table_kv_vec, (CVECTOR_DATA_LOCATION_CLEANER)cbytes_free, LOC_CBGT_0429);
        cvector_free_no_lock(user_table_kv_vec, LOC_CBGT_0430);
        cvector_set_no_lock(report_vec, pos, NULL_PTR);
    }

    cvector_free_no_lock(report_vec, LOC_CBGT_0431);
...
EC_BOOL cbgt_select_in_meta(const UINT32 cbgt_md_id, const UINT32 cached_mode, const CBYTES *table_name, const CSTRING *row_pattern, const CSTRING *colf_pattern, const CSTRING *colq_pattern, const CSTRING *val_pattern, CVECTOR *ret_kv_vec)
{
    ...
    cbgt_md = CBGT_MD_GET(cbgt_md_id);
    CBGT_MD_WAS_ACCESS(cbgt_md, LOC_CBGT_0432);
    ...
    if(EC_FALSE == cbgt_is_root_server(cbgt_md_id))
    {
        ...
        task_p2p(cbgt_md_id, TASK_DEFAULT_LIVE, TASK_PRIO_NORMAL, TASK_NEED_RSP_FLAG, TASK_NEED_ALL_RSP,
                 CBGT_MD_ROOT_MOD(cbgt_md) ,
                 &ret, FI_cbgt_select_in_meta, ERR_MODULE_ID, cached_mode, 
...
EC_BOOL cbgt_select_in_colf(const UINT32 cbgt_md_id, const UINT32 cached_mode, const CBYTES *table_name, const CBYTES *colf_name, const CSTRING *row_pattern,  const CSTRING *colq_pattern, const CSTRING *val_pattern, CVECTOR *ret_kv_vec)
{
    ...
    cbgt_md = CBGT_MD_GET(cbgt_md_id);
    CBGT_MD_WAS_ACCESS(cbgt_md, LOC_CBGT_0433);
    ...
    if(EC_FALSE == cbgt_is_root_server(cbgt_md_id))
    {
        ...
        task_p2p(cbgt_md_id, TASK_DEFAULT_LIVE, TASK_PRIO_NORMAL, TASK_NEED_RSP_FLAG, TASK_NEED_ALL_RSP,
                 CBGT_MD_ROOT_MOD(cbgt_md) ,
                 &ret, FI_cbgt_select_in_colf, ERR_MODULE_ID, cached_mode, 
...
EC_BOOL cbgt_select(const UINT32 cbgt_md_id, const UINT32 cached_mode, const CSTRING *table_pattern, const CSTRING *row_pattern, const CSTRING *colf_pattern, const CSTRING *colq_pattern, const CSTRING *val_pattern, CVECTOR *ret_kv_vec)
{
    ...
    if(EC_FALSE == cbgt_is_root_server(cbgt_md_id))
    {
        ...
        task_p2p(cbgt_md_id, TASK_DEFAULT_LIVE, TASK_PRIO_NORMAL, TASK_NEED_RSP_FLAG, TASK_NEED_ALL_RSP,
                 CBGT_MD_ROOT_MOD(cbgt_md) ,
                 &ret, FI_cbgt_select_from_root, ERR_MODULE_ID, cached_mode, 
...
void cbgt_traversal_no_lock(const UINT32 cbgt_md_id, LOG *log)
{
    ...
    server_type = CBGT_MD_TYPE(cbgt_md);
    table_id    = CBGT_MD_TABLE_ID(cbgt_md);
    CBGT_MD_WAS_ACCESS(cbgt_md, LOC_CBGT_0434);
...
void cbgt_traversal(const UINT32 cbgt_md_id, LOG *log)
{
    ...
    cbgt_md = CBGT_MD_GET(cbgt_md_id);
    CBGT_MD_WAS_ACCESS(cbgt_md, LOC_CBGT_0435);

    CBGT_MD_CRWLOCK_TABLE_RDLOCK(cbgt_md, LOC_CBGT_0436);
    cbgt_traversal_no_lock(cbgt_md_id, log);
    CBGT_MD_CRWLOCK_TABLE_UNLOCK(cbgt_md, LOC_CBGT_0437);
    return;
}
...
void cbgt_runthrough_no_lock(const UINT32 cbgt_md_id, LOG *log)
{
    ...
    server_type = CBGT_MD_TYPE(cbgt_md);
    table_id    = CBGT_MD_TABLE_ID(cbgt_md);
    CBGT_MD_WAS_ACCESS(cbgt_md, LOC_CBGT_0438);
...
void cbgt_runthrough(const UINT32 cbgt_md_id, LOG *log)
{
    ...
    cbgt_md = CBGT_MD_GET(cbgt_md_id);
    CBGT_MD_WAS_ACCESS(cbgt_md, LOC_CBGT_0439);

    CBGT_MD_CRWLOCK_TABLE_RDLOCK(cbgt_md, LOC_CBGT_0440);
    cbgt_runthrough_no_lock(cbgt_md_id, log);
    CBGT_MD_CRWLOCK_TABLE_UNLOCK(cbgt_md, LOC_CBGT_0441);
...
void cbgt_traversal_depth(const UINT32 cbgt_md_id, LOG *log)
{
    ...
    server_type = CBGT_MD_TYPE(cbgt_md);
    table_id    = CBGT_MD_TABLE_ID(cbgt_md);
    CBGT_MD_WAS_ACCESS(cbgt_md, LOC_CBGT_0442);
    ...
    for(pos = 0; pos < cvector_size(MOD_MGR_REMOTE_LIST(mod_mgr)); pos ++)
    {
        ...
        task_p2p(cbgt_md_id, TASK_DEFAULT_LIVE, TASK_PRIO_NORMAL, TASK_NEED_RSP_FLAG, TASK_NEED_ALL_RSP,
                 mod_node,
                 &ret,FI_cbgt_traversal_depth, ERR_MODULE_ID, log);
    }
...
void cbgt_runthrough_depth(const UINT32 cbgt_md_id, LOG *log)
{
    ...
    server_type = CBGT_MD_TYPE(cbgt_md);
    table_id    = CBGT_MD_TABLE_ID(cbgt_md);
    CBGT_MD_WAS_ACCESS(cbgt_md, LOC_CBGT_0443);
    ...
    for(pos = 0; pos < cvector_size(MOD_MGR_REMOTE_LIST(mod_mgr)); pos ++)
    {
        ...
        task_p2p(cbgt_md_id, TASK_DEFAULT_LIVE, TASK_PRIO_NORMAL, TASK_NEED_RSP_FLAG, TASK_NEED_ALL_RSP,
                 mod_node,
                 &ret,FI_cbgt_runthrough_depth, ERR_MODULE_ID, log);
    }
