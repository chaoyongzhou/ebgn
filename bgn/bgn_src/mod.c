...
{
    alloc_static_mem(MD_TASK, 0, MM_MOD_NODE, mod_node, LOC_MOD_0001);
    return (EC_TRUE);
}
...
MOD_NODE *mod_node_new()
{
    ...
    alloc_static_mem(MD_TASK, 0, MM_MOD_NODE, &mod_node, LOC_MOD_0002);
...
static MOD_NODE *mod_node_alloc_0()
{
    ...
    alloc_static_mem(MD_TASK, 0, MM_MOD_NODE, &mod_node, LOC_MOD_0003);
    return (mod_node);
}
...
EC_BOOL mod_node_free(MOD_NODE *mod_node)
{
    ...
    free_static_mem(MD_TASK, 0, MM_MOD_NODE, mod_node, LOC_MOD_0004);
    return (EC_TRUE);
}
...
UINT32 mod_node_init_0(const UINT32 md_id, MOD_NODE *mod_node)
{
    mod_node_init(mod_node);
    return (0);
}

UINT32 mod_node_clean_0(const UINT32 md_id, MOD_NODE *mod_node)
{
    mod_node_clean(mod_node);
    return (0);
}

UINT32 mod_node_free_0(const UINT32 md_id, MOD_NODE *mod_node)
{
...
EC_BOOL mod_mgr_init(MOD_MGR * mod_mgr, const UINT32 local_md_id, const UINT32 load_balancing_choice)
{
...
{
    alloc_static_mem(MD_TASK, 0, MM_MOD_MGR, mod_mgr, LOC_MOD_0006);
    return (0);
}
*/
MOD_MGR * mod_mgr_new(const UINT32 local_md_id, const UINT32 load_balancing_choice)
{
    ...
    task_brd = task_brd_default_get();
    mod_mgr_init(mod_mgr, local_md_id, load_balancing_choice);
...
/*trick! used by creg*/
void mod_mgr_free(MOD_MGR *mod_mgr)
{
    TASK_BRD *task_brd;
    ...
    if(EC_TRUE == task_brd_mod_mgr_rmv(task_brd, mod_mgr))
    {
        ...
        free_static_mem(MD_TASK, 0, MM_MOD_MGR, mod_mgr, LOC_MOD_0008);
    }
    return ;
}

void mod_mgr_free_0(const UINT32 md_id, MOD_MGR *mod_mgr)
{
...
EC_BOOL mod_mgr_clean(MOD_MGR * mod_mgr)
{
    ...
    cvector_clean(remote_mod_node_list, (F_CLEANER)mod_node_free, LOC_MOD_0009);
    MOD_MGR_REMOTE_POS(mod_mgr) = 0;
    MOD_MGR_LOCAL_MOD_POS(mod_mgr) = CVECTOR_ERR_POS;
...
UINT32 mod_mgr_init_0(const UINT32 task_id, MOD_MGR * mod_mgr)
{
    return mod_mgr_init(mod_mgr, CMPI_ERROR_MODI, LOAD_BALANCING_LOOP);
}

UINT32 mod_mgr_clean_0(const UINT32 task_id, MOD_MGR * mod_mgr)
{
    return mod_mgr_clean(mod_mgr);
}
...
MOD_NODE *mod_mgr_find_min_load_with_tcid_vec_excl_filter(const MOD_MGR *mod_mgr, const CVECTOR *tcid_vec)
{
    ...
    CVECTOR_LOCK(MOD_MGR_REMOTE_LIST(mod_mgr), LOC_MOD_0010);
    ...
    CVECTOR_UNLOCK(MOD_MGR_REMOTE_LIST(mod_mgr), LOC_MOD_0011);
...
MOD_NODE *mod_mgr_find_min_load_with_rank_vec_excl_filter(const MOD_MGR *mod_mgr, const CVECTOR *rank_vec)
{
    ...
    CVECTOR_LOCK(MOD_MGR_REMOTE_LIST(mod_mgr), LOC_MOD_0012);
    for(mod_node_pos = 0; mod_node_pos < cvector_size(MOD_MGR_REMOTE_LIST(mod_mgr)); mod_node_pos ++)
    {
        MOD_NODE   *remote_mod_node;
    ...
    CVECTOR_UNLOCK(MOD_MGR_REMOTE_LIST(mod_mgr), LOC_MOD_0013);
...
MOD_NODE *mod_mgr_find_min_load_with_modi_vec_excl_filter(const MOD_MGR *mod_mgr, const CVECTOR *modi_vec)
{
    ...
    CVECTOR_LOCK(MOD_MGR_REMOTE_LIST(mod_mgr), LOC_MOD_0014);
    for(mod_node_pos = 0; mod_node_pos < cvector_size(MOD_MGR_REMOTE_LIST(mod_mgr)); mod_node_pos ++)
    {
        MOD_NODE   *remote_mod_node;
    ...
    CVECTOR_UNLOCK(MOD_MGR_REMOTE_LIST(mod_mgr), LOC_MOD_0015);
...
MOD_NODE * mod_mgr_ldb_que_get(MOD_MGR *mod_mgr)
{
    ...
    CVECTOR_LOCK(MOD_MGR_REMOTE_LIST(mod_mgr), LOC_MOD_0016);
...
MOD_NODE * mod_mgr_ldb_obj_get(MOD_MGR *mod_mgr)
{
    ...
    CVECTOR_LOCK(MOD_MGR_REMOTE_LIST(mod_mgr), LOC_MOD_0019);
    num = cvector_size(MOD_MGR_REMOTE_LIST(mod_mgr));
...
MOD_NODE * mod_mgr_ldb_cpu_get(MOD_MGR *mod_mgr)
{
    ...
    CVECTOR_LOCK(MOD_MGR_REMOTE_LIST(mod_mgr), LOC_MOD_0022);
    num = cvector_size(MOD_MGR_REMOTE_LIST(mod_mgr));
...
MOD_NODE * mod_mgr_ldb_mem_get(MOD_MGR *mod_mgr)
{
    ...
    CVECTOR_LOCK(MOD_MGR_REMOTE_LIST(mod_mgr), LOC_MOD_0025);
    num = cvector_size(MOD_MGR_REMOTE_LIST(mod_mgr));
...
MOD_NODE * mod_mgr_ldb_dsk_get(MOD_MGR *mod_mgr)
{
    ...
    CVECTOR_LOCK(MOD_MGR_REMOTE_LIST(mod_mgr), LOC_MOD_0028);
    num = cvector_size(MOD_MGR_REMOTE_LIST(mod_mgr));
...
MOD_NODE * mod_mgr_ldb_net_get(MOD_MGR *mod_mgr)
{
    ...
    CVECTOR_LOCK(MOD_MGR_REMOTE_LIST(mod_mgr), LOC_MOD_0031);
    num = cvector_size(MOD_MGR_REMOTE_LIST(mod_mgr));
