...
CROUTER_NODE *crouter_node_new(const UINT32 des_tcid)
{
    ...
    alloc_static_mem(MD_TASK, 0, MM_CROUTER_NODE, &crouter_node, LOC_CROUTER_0001);
...
CROUTER_NODE_VEC *crouter_node_vec_new()
{
    ...
    alloc_static_mem(MD_TASK, 0, MM_CROUTER_NODE_VEC, &crouter_node_vec, LOC_CROUTER_0017);
...
CROUTER_CFG *crouter_cfg_new(const UINT32 src_tcid, const UINT32 des_tcid, const UINT32 next_hop, const UINT32 max_hops)
{
    ...
    alloc_static_mem(MD_TASK, 0, MM_CROUTER_CFG, &crouter_cfg, LOC_CROUTER_0036);
...
CROUTER_CFG *crouter_cfg_new_0()
{
    ...
    alloc_static_mem(MD_TASK, 0, MM_CROUTER_CFG, &crouter_cfg, LOC_CROUTER_0037);
