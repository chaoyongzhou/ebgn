...
static EC_BOOL cdfsdn_unlink_file(const char *file_name)
{
...
static void cdfsdn_copy_buff(const UINT8 *src_buff, const UINT32 src_len, UINT8 *des_buff, const UINT32 max_len, UINT32 *len)
{
    (*len) = DMIN(src_len, max_len);
    BCOPY(src_buff, des_buff, (*len));
    return;
}

static void cdfsdn_set_buff(UINT8 *buff, const UINT32 len, const UINT8 ch)
{
    BSET(buff, ch, len);
    return;
}

static void cdfsdn_print_buff_0(LOG *log, const UINT8 *buff, const UINT32 len)
{
    UINT32 pos;
...
static void cdfsdn_print_buff_1(LOG *log, const UINT8 *buff, const UINT32 len)
{
    UINT32 pos;
...
static void cdfsdn_print_buff(LOG *log, const UINT8 *buff, const UINT32 len)
{
...
CDFSDN_CACHE *cdfsdn_cache_new()
{
    ...
    alloc_static_mem(MD_TASK, CMPI_ANY_MODI, MM_CDFSDN_CACHE, &cdfsdn_cache, LOC_CDFSDN_0001);
...
EC_BOOL cdfsdn_cache_free(CDFSDN_CACHE *cdfsdn_cache)
{
    if(NULL_PTR != cdfsdn_cache)
    {
        ...
        free_static_mem(MD_TASK, CMPI_ANY_MODI, MM_CDFSDN_CACHE, cdfsdn_cache, LOC_CDFSDN_0002);
    }
    return (EC_TRUE);
}
...
CDFSDN_STAT *cdfsdn_stat_new()
{
    ...
    alloc_static_mem(MD_CDFS, CMPI_ANY_MODI, MM_CDFSDN_STAT, &cdfsdn_stat, LOC_CDFSDN_0003);
...
EC_BOOL cdfsdn_stat_free(CDFSDN_STAT *cdfsdn_stat)
{
    if(NULL_PTR != cdfsdn_stat)
    {
        ...
        free_static_mem(MD_CDFS, CMPI_ANY_MODI, MM_CDFSDN_STAT, cdfsdn_stat, LOC_CDFSDN_0004);
    }
    return (EC_TRUE);
}

EC_BOOL cdfsdn_stat_init_0(const UINT32 md_id, CDFSDN_STAT *cdfsdn_stat)
{
    return cdfsdn_stat_init(cdfsdn_stat);
}

EC_BOOL cdfsdn_stat_clean_0(const UINT32 md_id, CDFSDN_STAT *cdfsdn_stat)
{
    return cdfsdn_stat_clean(cdfsdn_stat);
}

EC_BOOL cdfsdn_stat_free_0(const UINT32 md_id, CDFSDN_STAT *cdfsdn_stat)
{
    return cdfsdn_stat_free(cdfsdn_stat);
}
...
EC_BOOL cdfsdn_record_mgr_free(CDFSDN_RECORD_MGR *cdfsdn_record_mgr)
{
    if(NULL_PTR != cdfsdn_record_mgr)
    {
        ...
        CDFSDN_RECORD_MGR_NODE_TBL(cdfsdn_record_mgr) = NULL_PTR;
        free_static_mem(MD_TASK, CMPI_ANY_MODI, MM_CDFSDN_RECORD_MGR, cdfsdn_record_mgr, LOC_CDFSDN_0012);
    }
    return (EC_TRUE);
}
...
EC_BOOL cdfsdn_record_init_0(const UINT32 md_id, CDFSDN_RECORD *cdfsdn_record)
{
    return (EC_TRUE);
}

EC_BOOL cdfsdn_record_clean_0(const UINT32 md_id, CDFSDN_RECORD *cdfsdn_record)
{
    return (EC_TRUE);
}

EC_BOOL cdfsdn_record_free_0(const UINT32 md_id, CDFSDN_RECORD *cdfsdn_record)
{
    return (EC_TRUE);
}
...
CDFSDN_BLOCK *cdfsdn_block_new(const char *block_root_dir)
{
    ...
    alloc_static_mem(MD_TASK, CMPI_ANY_MODI, MM_CDFSDN_BLOCK, &cdfsdn_block, LOC_CDFSDN_0015);
...
EC_BOOL cdfsdn_block_free(CDFSDN_BLOCK *cdfsdn_block)
{
    if(NULL_PTR != cdfsdn_block)
    {
        ...
        free_static_mem(MD_TASK, CMPI_ANY_MODI, MM_CDFSDN_BLOCK, cdfsdn_block, LOC_CDFSDN_0016);
    }
    return (EC_TRUE);
}

EC_BOOL cdfsdn_block_init_0(const UINT32 md_id, CDFSDN_BLOCK *cdfsdn_block)
{
    return cdfsdn_block_init(cdfsdn_block, "undef");
}

EC_BOOL cdfsdn_block_clean_0(const UINT32 md_id, CDFSDN_BLOCK *cdfsdn_block)
{
    return cdfsdn_block_clean(cdfsdn_block);
}

EC_BOOL cdfsdn_block_free_0(const UINT32 md_id, CDFSDN_BLOCK *cdfsdn_block)
{
    return cdfsdn_block_free(cdfsdn_block);
}
...
CDFSDN *cdfsdn_new(const char *root_dir)
{
    ...
    alloc_static_mem(MD_TASK, CMPI_ANY_MODI, MM_CDFSDN, &cdfsdn, LOC_CDFSDN_0032);
    if(NULL_PTR != cdfsdn)
    {
...
EC_BOOL cdfsdn_free(CDFSDN *cdfsdn)
{
    ...
    {
        cdfsdn_clean(cdfsdn);
        free_static_mem(MD_TASK, CMPI_ANY_MODI, MM_CDFSDN, cdfsdn, LOC_CDFSDN_0036);
    }
    return (EC_TRUE);
}
...
EC_BOOL cdfsdn_show(LOG *log, const char *root_dir)
{
    ...
    if(0 != access(root_dir, F_OK))/*exist*/
    {
