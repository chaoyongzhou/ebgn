...
UINT32 ctimer_start(const UINT32 ctimer_expire_delta)
{
    ...
    /* initilize new one CTIMER module */
...
CTIMER_NODE *ctimer_node_new()
{
    ...
    alloc_static_mem(MD_CTIMER, CMPI_ANY_MODI, MM_CTIMER_NODE, &ctimer_node, LOC_CTIMER_0003);
...
UINT32 ctimer_node_free(CTIMER_NODE *ctimer_node)
{
    ...
    free_static_mem(MD_CTIMER, CMPI_ANY_MODI, MM_CTIMER_NODE, ctimer_node, LOC_CTIMER_0004);
    return (0);
}
