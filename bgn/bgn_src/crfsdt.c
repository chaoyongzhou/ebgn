...
CRFSDT_PNODE *crfsdt_pnode_new()
{
    ...
    alloc_static_mem(MD_CRFS, CMPI_ANY_MODI, MM_CRFSDT_PNODE, &crfsdt_pnode, LOC_CRFSDT_0001);
...
EC_BOOL crfsdt_pnode_free(CRFSDT_PNODE *crfsdt_pnode)
{
    if(NULL_PTR != crfsdt_pnode)
    {
        ...
        free_static_mem(MD_CRFS, CMPI_ANY_MODI, MM_CRFSDT_PNODE, crfsdt_pnode, LOC_CRFSDT_0002);        
    }
    return (EC_TRUE);
}

EC_BOOL crfsdt_pnode_init_0(const UINT32 md_id, CRFSDT_PNODE *crfsdt_pnode)
{
    return crfsdt_pnode_init(crfsdt_pnode);
}

EC_BOOL crfsdt_pnode_clean_0(const UINT32 md_id, CRFSDT_PNODE *crfsdt_pnode)
{
    return crfsdt_pnode_clean(crfsdt_pnode);
}

EC_BOOL crfsdt_pnode_free_0(const UINT32 md_id, CRFSDT_PNODE *crfsdt_pnode)
{
    return crfsdt_pnode_free(crfsdt_pnode);
}
...
{
    return crfsconhash_del_node(CRFSDT_PNODE_CONHASH(crfsdt_pnode), (uint32_t)tcid, CRFSCONHASH_ANY_REPLICAS);
}
...
CRFSDT_RNODE *crfsdt_rnode_new()
{
    ...
    alloc_static_mem(MD_CRFS, CMPI_ANY_MODI, MM_CRFSDT_RNODE, &crfsdt_rnode, LOC_CRFSDT_0003);
...
EC_BOOL crfsdt_rnode_free(CRFSDT_RNODE *crfsdt_rnode)
{
    if(NULL_PTR != crfsdt_rnode)
    {
        ...
        free_static_mem(MD_CRFS, CMPI_ANY_MODI, MM_CRFSDT_RNODE, crfsdt_rnode, LOC_CRFSDT_0004);        
    }
    return (EC_TRUE);
}
...
CRFSDT *crfsdt_new()
{
    ...
    alloc_static_mem(MD_CRFS, CMPI_ANY_MODI, MM_CRFSDT, &crfsdt, LOC_CRFSDT_0006);
    if(NULL_PTR == crfsdt)
    {
...
EC_BOOL crfsdt_free(CRFSDT *crfsdt)
{
    ...
    {
        crfsdt_clean(crfsdt);
        free_static_mem(MD_CRFS, CMPI_ANY_MODI, MM_CRFSDT, crfsdt, LOC_CRFSDT_0009);        
    }
    return (EC_TRUE);
}
