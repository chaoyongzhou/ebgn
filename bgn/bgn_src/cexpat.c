...
CEXPAT_ATTR *cexpat_attr_new()
{
    ...
    alloc_static_mem(MD_TBD, 0, MM_CEXPAT_ATTR, &cexpat_attr, LOC_CEXPAT_0001);
...
EC_BOOL cexpat_attr_free(CEXPAT_ATTR *cexpat_attr)
{
    if(NULL_PTR != cexpat_attr)
    {
        ...
        free_static_mem(MD_TBD, 0, MM_CEXPAT_ATTR, cexpat_attr, LOC_CEXPAT_0002);
    }
    return (EC_TRUE);
}
...
CEXPAT_ATTR *cexpat_attr_make(const uint8_t *name, const uint8_t *val)
{
    ...
    alloc_static_mem(MD_TBD, 0, MM_CEXPAT_ATTR, &cexpat_attr, LOC_CEXPAT_0003);
    if(NULL_PTR == cexpat_attr)
    {
...
CEXPAT_NODE *cexpat_node_new()
{
    ...
    alloc_static_mem(MD_TBD, 0, MM_CEXPAT_NODE, &cexpat_node, LOC_CEXPAT_0004);
...
EC_BOOL cexpat_node_clean(CEXPAT_NODE *cexpat_node)
{
    ...
    {
        cbytes_free(CEXPAT_NODE_CDATA(cexpat_node), LOC_CEXPAT_0009);
        CEXPAT_NODE_CDATA(cexpat_node) = NULL_PTR;
    }
...
EC_BOOL cexpat_node_free(CEXPAT_NODE *cexpat_node)
{
    if(NULL_PTR != cexpat_node)
    {
        ...
        free_static_mem(MD_TBD, 0, MM_CEXPAT_NODE, cexpat_node, LOC_CEXPAT_0010);
    }
    return (EC_TRUE);
}
...
CEXPAT_NODE *cexpat_node_make(const uint8_t *name)
{
    ...
    alloc_static_mem(MD_TBD, 0, MM_CEXPAT_NODE, &cexpat_node, LOC_CEXPAT_0011);
    if(NULL_PTR == cexpat_node)
    {
...
static void __cexpat_node_parse_header(void *arg, const char *str, int len) 
{
    ...
    safe_free(str_dup, LOC_CEXPAT_0001);
