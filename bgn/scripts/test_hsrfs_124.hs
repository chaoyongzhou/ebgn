...
hsrfsc add dir /h1 10.10.10.1 on tcid 10.10.30.1 at console
hsrfsc rollback dt on tcid 10.10.30.1 at console
hsrfsc flush dt on tcid 10.10.30.1 at console
