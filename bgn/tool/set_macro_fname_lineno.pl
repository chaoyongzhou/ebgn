...
sub update_macro_location_of_line
{
    ...
    if($line =~ /LOC_[A-Z0-9]+_[0-9]+/)
    {
        #printf STDOUT "%s\n", $line;
        $location = &gen_location($file, $lineno);
        $line =~ s/LOC_[A-Z0-9]+_[0-9]+/$location/g;
        #printf STDOUT "==> %s\n", $line;
    }
    return $line;    
}
...
sub create_tag_table
{
    ...
    push(@$tags, "CDFSDN_RECORD_MGR_INIT_CMUTEX_LOCK");
    push(@$tags, "CDFSDN_RECORD_MGR_CLEAN_CMUTEX_LOCK");
    push(@$tags, "CDFSDN_RECORD_MGR_CMUTEX_LOCK");
    push(@$tags, "CDFSDN_RECORD_MGR_CMUTEX_UNLOCK");

    push(@$tags, "CDFSNP_INIT_LOCK");
    push(@$tags, "CDFSNP_CLEAN_LOCK");
    push(@$tags, "CDFSNP_LOCK");
    push(@$tags, "CDFSNP_UNLOCK");

    push(@$tags, "CDFSDN_NODE_INIT_LOCK");
    push(@$tags, "CDFSDN_NODE_CLEAN_LOCK");
    push(@$tags, "CDFSDN_NODE_LOCK");
    push(@$tags, "CDFSDN_NODE_UNLOCK");    

    push(@$tags, "CDFSNP_MGR_INIT_LOCK");    
    push(@$tags, "CDFSNP_MGR_CLEAN_LOCK");    
    push(@$tags, "CDFSNP_MGR_LOCK");    
    push(@$tags, "CDFSNP_MGR_UNLOCK");    

    push(@$tags, "CDFSNP_INC_READER_WITH_LOCK");
    push(@$tags, "CDFSNP_DEC_READER_WITH_LOCK");

    push(@$tags, "CDFSNP_INC_READER_WITHOUT_LOCK");
    push(@$tags, "CDFSNP_DEC_READER_WITHOUT_LOCK");
    ...
    push(@$tags, "keyValueFreeHs");
    push(@$tags, "keyValueNewHs");
    push(@$tags, "keyValueMakeHs");
    push(@$tags, "keyValueUnMakeHs");
    push(@$tags, "keyValueCleanHs");
    push(@$tags, "keyValueSetHs");

    push(@$tags, "kvNewHs");
    push(@$tags, "kvFreeHs");
    
    push(@$tags, "keyDupBase");
    push(@$tags, "keyNewBase");
    push(@$tags, "keyFreeBase");
    return;
}
