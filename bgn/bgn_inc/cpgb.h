...
#define CPGB_PAGE_4K_ERR_HI_BITS_MASK ((uint16_t)0x8000)     /*for 2k-page, is 0x0000*/
...
typedef struct
{
    ...
    uint16_t     pgb_page_4k_max_num; /*max page number*/
    uint16_t     pgb_page_4k_used_num;/*used page number*/
...
#define CPGB_PAGE_4K_MAX_NUM(cpgb)                         ((cpgb)->pgb_page_4k_max_num)
#define CPGB_PAGE_4K_USED_NUM(cpgb)                        ((cpgb)->pgb_page_4k_used_num)
...
#define CPGB_CONF_PAGE_4K_NUM(cpgb_conf)        ((cpgb_conf)->page_4k_num)
