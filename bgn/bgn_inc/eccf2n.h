...
/* ECCF2N MODULE Defintion: */
typedef struct
{
    /* used counter >= 0 */
    UINT32 usedcounter ;

    /* BGNZN Module ID refered by ECCF2N Module */
    UINT32 bgnzn_md_id;

    /* BGNF2N Module ID refered by ECCF2N Module */
    UINT32 bgnf2n_md_id;

    /* ECF2N Module ID refered by ECCF2N Module */
    UINT32 ecf2n_md_id;

    /* BGNZ Module ID refered by ECCF2N Module */
    UINT32 bgnz_md_id;
    ...
    /* the cofactor of the elliptic curve(ec) */
