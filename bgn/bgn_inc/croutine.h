...
#define croutine_cond_new(location)                              coroutine_cond_new(location)

#define croutine_cond_init(croutine_cond, location)              coroutine_cond_init(croutine_cond, location)
...
#define CROUTINE_NODE_COND_INIT(croutine_node, location)                           COROUTINE_NODE_COND_INIT(croutine_node, location)   
...
#define croutine_cond_new(location)                              ccond_new(location)

#define croutine_cond_init(croutine_cond, location)              ccond_init(croutine_cond, location)
...
#define CROUTINE_NODE_COND_INIT(croutine_node, location)                           CTHREAD_NODE_CCOND_INIT(croutine_node, location)   
