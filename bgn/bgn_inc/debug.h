...
#define              e_dbg_FUNC_RAND_GEN    ((UINT32)  5)
#define                  e_dbg_FUNC_HASH    ((UINT32)  6)
#define                    e_dbg_EC_BOOL    ((UINT32)  7)
#define                 e_dbg_UINT32_ptr    ((UINT32)  8)
#define                 e_dbg_UINT16_ptr    ((UINT32)  9)
#define                  e_dbg_UINT8_ptr    ((UINT32) 10)
#define                    e_dbg_int_ptr    ((UINT32) 11)
#define                   e_dbg_void_ptr    ((UINT32) 12)
#define                   e_dbg_REAL_ptr    ((UINT32) 13)
#define                 e_dbg_BIGINT_ptr    ((UINT32) 14)
#define                   e_dbg_EBGN_ptr    ((UINT32) 15)
#define              e_dbg_EBGN_ITEM_ptr    ((UINT32) 16)
#define         e_dbg_EC_CURVE_POINT_ptr    ((UINT32) 17)
#define     e_dbg_EC_CURVE_AFF_POINT_ptr    ((UINT32) 18)
#define            e_dbg_ECF2N_CURVE_ptr    ((UINT32) 19)
#define             e_dbg_ECFP_CURVE_ptr    ((UINT32) 20)
#define            e_dbg_ECC_KEYPAIR_ptr    ((UINT32) 21)
#define          e_dbg_ECC_SIGNATURE_ptr    ((UINT32) 22)
#define                   e_dbg_POLY_ptr    ((UINT32) 23)
#define              e_dbg_POLY_ITEM_ptr    ((UINT32) 24)
#define                 e_dbg_DEGREE_ptr    ((UINT32) 25)
#define                e_dbg_VECTORR_ptr    ((UINT32) 26)
#define          e_dbg_VECTORR_BLOCK_ptr    ((UINT32) 27)
#define                e_dbg_MATRIXR_ptr    ((UINT32) 28)
#define          e_dbg_MATRIXR_BLOCK_ptr    ((UINT32) 29)
#define          e_dbg_FUNC_RAND_GEN_ptr    ((UINT32) 30)
#define              e_dbg_FUNC_HASH_ptr    ((UINT32) 31)
#define                e_dbg_MOD_MGR_ptr    ((UINT32) 32)
#define               e_dbg_DMATRIXR_ptr    ((UINT32) 33)
#define                e_dbg_CSTRING_ptr    ((UINT32) 34)
#define              e_dbg_TASKC_MGR_ptr    ((UINT32) 35)
#define               e_dbg_VMM_NODE_ptr    ((UINT32) 36)
#define                    e_dbg_LOG_ptr    ((UINT32) 37)
#define              e_dbg_CFILE_SEG_ptr    ((UINT32) 38)
#define                e_dbg_CVECTOR_ptr    ((UINT32) 39)
#define             e_dbg_CFILE_NODE_ptr    ((UINT32) 40)
#define                  e_dbg_KBUFF_ptr    ((UINT32) 41)
#define               e_dbg_CDIR_SEG_ptr    ((UINT32) 42)
#define              e_dbg_CDIR_NODE_ptr    ((UINT32) 43)
#define               e_dbg_CMON_OBJ_ptr    ((UINT32) 44)
#define           e_dbg_CMON_OBJ_VEC_ptr    ((UINT32) 45)
#define          e_dbg_CSOCKET_CNODE_ptr    ((UINT32) 46)
#define             e_dbg_TASKC_NODE_ptr    ((UINT32) 47)
#define          e_dbg_CSYS_CPU_STAT_ptr    ((UINT32) 48)
#define     e_dbg_MM_MAN_OCCUPY_NODE_ptr    ((UINT32) 49)
#define       e_dbg_MM_MAN_LOAD_NODE_ptr    ((UINT32) 50)
#define            e_dbg_MM_MOD_NODE_ptr    ((UINT32) 51)
#define      e_dbg_CPROC_MODULE_STAT_ptr    ((UINT32) 52)
#define      e_dbg_CRANK_THREAD_STAT_ptr    ((UINT32) 53)
#define          e_dbg_CSYS_ETH_STAT_ptr    ((UINT32) 54)
#define          e_dbg_CSYS_DSK_STAT_ptr    ((UINT32) 55)
#define       e_dbg_TASK_REPORT_NODE_ptr    ((UINT32) 56)
#define           e_dbg_CDFSNP_FNODE_ptr    ((UINT32) 57)
#define            e_dbg_CDFSNP_ITEM_ptr    ((UINT32) 58)
#define            e_dbg_CDFSDN_STAT_ptr    ((UINT32) 59)
#define             e_dbg_CLOAD_STAT_ptr    ((UINT32) 60)
#define             e_dbg_CLOAD_NODE_ptr    ((UINT32) 61)
#define              e_dbg_CLOAD_MGR_ptr    ((UINT32) 62)
#define             e_dbg_CFUSE_MODE_ptr    ((UINT32) 63)
#define             e_dbg_CFUSE_STAT_ptr    ((UINT32) 64)
#define          e_dbg_CDFSDN_RECORD_ptr    ((UINT32) 65)
#define           e_dbg_CDFSDN_BLOCK_ptr    ((UINT32) 66)
#define                 e_dbg_CBYTES_ptr    ((UINT32) 67)
#define               e_dbg_MOD_NODE_ptr    ((UINT32) 68)
#define                 e_dbg_CTIMET_ptr    ((UINT32) 69)
#define          e_dbg_CSESSION_NODE_ptr    ((UINT32) 70)
#define          e_dbg_CSESSION_ITEM_ptr    ((UINT32) 71)
#define                 e_dbg_CSWORD_ptr    ((UINT32) 72)
#define                  e_dbg_CSDOC_ptr    ((UINT32) 73)
...
#define IS_MODULE_ID_TYPE(type) (1) /*obsolete due to xx_MD_ID type is deprecated*/

/* priority of modules: value higher, priority higher*/
/*E_MD_PRIORITY*/
#define                         PRIO_BEG    ((UINT32)  0) /*lowest priority*/
#define                     PRIO_MD_BGNZ    ((UINT32)  1)
#define                    PRIO_MD_EBGNZ    ((UINT32)  2)
#define                    PRIO_MD_BGNZ2    ((UINT32)  3)
#define                   PRIO_MD_EBGNZ2    ((UINT32)  4)
#define                     PRIO_MD_CONV    ((UINT32)  5)
#define                    PRIO_MD_BGNZN    ((UINT32)  6)
#define                   PRIO_MD_BGNF2N    ((UINT32)  7)
#define                    PRIO_MD_BGNFP    ((UINT32)  8)
#define                    PRIO_MD_ECF2N    ((UINT32)  9)
#define                     PRIO_MD_ECFP    ((UINT32) 10)
#define                   PRIO_MD_ECCF2N    ((UINT32) 11)
#define                    PRIO_MD_ECCFP    ((UINT32) 12)
#define                    PRIO_MD_POLYZ    ((UINT32) 13)
#define                   PRIO_MD_POLYZN    ((UINT32) 14)
#define                   PRIO_MD_POLYZ2    ((UINT32) 15)
#define                   PRIO_MD_POLYFP    ((UINT32) 16)
#define                  PRIO_MD_POLYF2N    ((UINT32) 17)
#define                    PRIO_MD_SEAFP    ((UINT32) 18)
#define                  PRIO_MD_VECTORR    ((UINT32) 19)
#define                  PRIO_MD_MATRIXR    ((UINT32) 20)
#define                 PRIO_MD_DMATRIXR    ((UINT32) 21)
#define                 PRIO_MD_VMATRIXR    ((UINT32) 22)
#define                    PRIO_MD_SUPER    ((UINT32) 23)
#define                      PRIO_MD_VMM    ((UINT32) 24)
#define                    PRIO_MD_CFILE    ((UINT32) 25)
#define                     PRIO_MD_CDIR    ((UINT32) 26)
#define                     PRIO_MD_CMON    ((UINT32) 27)
#define                      PRIO_MD_TBD    ((UINT32) 28)
#define                     PRIO_MD_CRUN    ((UINT32) 29)
#define                     PRIO_MD_CDFS    ((UINT32) 30)
#define                    PRIO_MD_CSOLR    ((UINT32) 31)
#define                     PRIO_MD_CBGT    ((UINT32) 32)
...
typedef struct
{
    UINT32  module_priority;    /* the module priority where module includes this function*/
...
typedef struct
{
    ...
    UINT32 func_index;      /*function index in g_dbg_func_addr_list defined in DEBUG module*/
    const UINT8  *func_name;/* function name stored in g_dbg_func_addr_list defined in DEBUG module*/

    FUNC_PARA_LIST func_para_list;
}TEST_CASE;
...
UINT32 dbg_get_func_by_code_addr(UINT32 code_addr, FUNC_ADDR_NODE *func_addr_node);
