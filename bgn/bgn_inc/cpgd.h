...
typedef struct
{
    ...
    uint32_t     pgd_page_4k_max_num; /*max pages number */
    uint32_t     pgd_page_4k_used_num;/*used pages number*/
...
#define CPGD_HDR_PAGE_4K_MAX_NUM(cpgd_hdr)                      ((cpgd_hdr)->pgd_page_4k_max_num)
#define CPGD_HDR_PAGE_4K_USED_NUM(cpgd_hdr)                     ((cpgd_hdr)->pgd_page_4k_used_num)
...
#define CPGD_PAGE_4K_MAX_NUM(cpgd)                               (CPGD_HDR_PAGE_4K_MAX_NUM(CPGD_HEADER(cpgd)))
#define CPGD_PAGE_4K_USED_NUM(cpgd)                              (CPGD_HDR_PAGE_4K_USED_NUM(CPGD_HEADER(cpgd)))
