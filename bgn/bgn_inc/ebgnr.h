...
typedef struct
{
    ...
    /*how many decimal after radix point*/
    UINT32 dec_prec;

    /*how many bits after radix point*/
    UINT32 bin_prec;

    EBGN *one;

    EBGN *five_offset;/* offset = 5 ^ dec_prec*/
    EBGN *ten_offset;/* offset = 10 ^ dec_prec*/

    /* EBGNZ Module ID refered by EBGNR Module */
    UINT32 ebgnz_md_id;

    /* BGNZ Module ID refered by EBGNR Module */
    UINT32 bgnz_md_id;
}EBGNR_MD;
...
*
*
*   ebgn_c = pi = 2 * SUM(1 + (i!/(2*i+1)!!), i = 0,1,2,...)
*
*
**/
