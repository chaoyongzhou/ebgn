...
/* ECCFP MODULE Defintion: */
typedef struct
{
    /* used counter >= 0 */
    UINT32 usedcounter ;

    /* BGNZN Module ID refered by ECCFP Module */
    UINT32 bgnzn_md_id;

    /* BGNFP Module ID refered by ECCFP Module */
    UINT32 bgnfp_md_id;

    /* ECFP Module ID refered by ECCFP Module */
    UINT32 ecfp_md_id;

    /* BGNZ Module ID refered by ECCFP Module */
    UINT32 bgnz_md_id;

    /* p represent the prime p of F_p */
    BIGINT *eccfp_p;
    ...
    /* user defined randon generator interface */
    const UINT32 ( *eccfp_random_generator)( BIGINT * random);

    /* user defined hash function interface */
...
*
**/
const UINT32 ecc_fp_random_generator_default( BIGINT * random);
